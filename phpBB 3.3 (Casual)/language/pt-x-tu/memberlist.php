...
$lang = array_merge($lang, [
	...
	'DEST_LANG'					=> 'Linguagem',
	'DEST_LANG_EXPLAIN'		=> 'Seleciona a linguagem apropriada (se ativada) para o destinatário desta mensagem.',

	'EDIT_PROFILE'				=> 'Editar Perfil',

	'EMAIL_BODY_EXPLAIN'		=> 'Esta mensagem será enviada como texto puro, não incluas qualquer código HTML ou BBCODE. O endereço de resposta desta mensagem é o teu endereço de email.',
	'EMAIL_DISABLED'			=> 'Todas as funções de email foram desativadas.',
	'EMAIL_SENT'				=> 'O email foi enviado.',
	'EMAIL_TOPIC_EXPLAIN'	=> 'Esta mensagem será enviada como texto puro, não incluas qualquer código HTML ou BBCODE. As informações daquele Tópico serão incluídas na mensagem. O endereço de resposta desta mensagem é o teu endereço de email.',
	...
	'FIND_USERNAME_EXPLAIN'	=> 'Utiliza este formulário para procurar Utilizadores. Não é necessário preencher todos os campos. Para dados parciais utiliza o *. Se indicares uma data, usa o formato <kbd>YYYY-MM-DD</kbd> ex. <samp>2004-02-29</samp>. Nas caixas de seleção escreve um ou mais nomes de utilizador (são aceites vários Utilizadores).',
