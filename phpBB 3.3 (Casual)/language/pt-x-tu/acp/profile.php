...
$lang = array_merge($lang, [
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'		=> 'Se esta opção estiver ativa, o campo será exibido apenas no Perfil dos Utilizadores e apenas Administradores e Moderadores poderão visualizar/preencher este campo.',
	...
	'STEP_2_EXPLAIN_CREATE'				=> 'Aqui podes definir algumas opções comuns. Além disso, podes prever o Campo que criaste, visualizando-o enquanto Utilizador. Por favor, testa as tuas configurações para verificares se tudo funciona corretamente.',
	'STEP_2_EXPLAIN_EDIT'				=> 'Aqui podes alterar algumas opções comuns. Além disso, podes prever o Campo alterado, visualizando-o enquanto Utilizador. Por favor, testa as tuas configurações para verificares se tudo funciona corretamente.<br /><strong>Tem em atenção que as alterações nos Campos do Perfil não afetam os Campos existentes preenchidos pelos utilizadores.</strong>',
