...
$lang = array_merge($lang, [
	...
	'IP_UNBAN_EXPLAIN'			=> 'Podes desbloquear (ou retirar a expulsão) múltiplos IPs apenas de uma só vez usando a combinação apropriada do rato e teclado do teu computador. IPs excluídos têm uma marcação no fundo.',
	...
	'USER_BAN_EXCLUDE_EXPLAIN'	=> 'Ativa esta opção para excluir Utilizadores da expulsão.',
	'USER_BAN_EXPLAIN'			=> 'Podes expulsar múltiplos Utilizadores de uma só vez, escrevendo um nome por linha. Usa <span style="text-decoration: underline;">Procurar Utilizador</span> para adicionar automaticamente um ou mais Utilizadores.',
	...
	'USER_UNBAN_EXPLAIN'			=> 'Podes desbloquear (ou retirar a expulsão) múltiplos IPs apenas de uma só vez usando a combinação apropriada do rato e teclado do teu computador. IPs expulsos têm uma marcação no fundo.',
]);
