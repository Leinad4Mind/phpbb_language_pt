...
$lang = array_merge($lang, [
	'ACP_SEARCH_INDEX_EXPLAIN'					=> 'Aqui podes gerir os índices de pesquisa do Fórum. Como normalmente utilizas apenas um modo de pesquisa, deves apagar todos os outros. Depois de alterares algumas das configurações da pesquisa (por exemplo, o número mínimo ou máximo de caracteres), é preciso recriar o índice para que as novas configurações se tornem efetivas.',
	...
	'COMMON_WORD_THRESHOLD_EXPLAIN'			=> 'Palavras que estão incluídas em grande percentagem em todas as Mensagens são consideradas comuns. As palavras comuns são ignoradas nas pesquisas. Escreve zero para desativar esta opção. Esta opção só terá efeito se o Fórum tiver mais de 100 Mensagens.',
	'CONFIRM_SEARCH_BACKEND'					=> 'Desejas alterar o modo de pesquisa? Depois de modificares o teu modo de pesquisa, deverás criar um novo índice para o novo modo selecionado. Se não planeias voltar ao teu modo de pesquisa antigo, poderás excluí-lo.',
	...
	'CONTINUE_INDEXING_EXPLAIN'				=> 'Um processo de criação de índice foi iniciado. Para voltares a aceder à página de índice da pesquisa, deves completar o processo ou cancelá-lo.',
	...
	'FULLTEXT_SPHINX_CONFIGURE'					=> 'Configura as definições seguintes para gerar o ficheiro sphinx',
	...
	'SEARCH_INDEX_REMOVED'					=> 'O Índice de Pesquisa foi removido com sucesso.',
	...
	'SEARCH_STORE_RESULTS_EXPLAIN'		=> 'A Cache dos resultados da pesquisa irá expirar após este tempo, em segundos. Escreve 0 se desejares desativar esta opção.',
	'SEARCH_TYPE'								=> 'Modo de pesquisa',
	'SEARCH_TYPE_EXPLAIN'					=> 'O phpBB permite-te selecionar o modo que será utilizado para a pesquisa de textos nos conteúdos da mensagem. Por padrão, será utilizado apenas o próprio sistema de pesquisas por textos completos.',
	'SWITCHED_SEARCH_BACKEND'				=> 'O modo de pesquisa foi selecionado com sucesso. Agora, para o utilizares, terás de te certificar da existência de um índice para o modo escolhido.',
