...
$lang = array_merge($lang, [
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'Aqui podes gerir todos os tipos de Módulos. O Painel de Administração tem uma estrutura de menus de três níveis (Categoria -> Categoria -> Módulo) diferente de outros que possuem uma estrutura de menu de dois níveis (Categoria -> Módulo) que precisam ser salvos. Tem em atenção que deves testar os resultados, já que te podes bloquear se desativares ou apagares os Módulos responsáveis pela própria Gestão de Módulos.',
	...
	'MODULE_DISPLAYED_EXPLAIN'		=> 'Se não desejares exibir este Módulo, mas gostarias de utilizá-lo, seleciona Não.',
