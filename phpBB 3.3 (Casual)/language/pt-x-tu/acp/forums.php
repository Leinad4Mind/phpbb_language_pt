...
$lang = array_merge($lang, [
	...
	'COPY_PERMISSIONS_ADD_EXPLAIN'	=> 'Quando criado, este Fórum terá as mesmas permissões do Fórum selecionado. Se não selecionares nenhum, o novo Fórum não será visível até que sejam definidas as suas Permissões.',
	'COPY_PERMISSIONS_EDIT_EXPLAIN'	=> 'Seleciona o Fórum cujas Permissões desejas copiar para este. Se não selecionares nenhum Fórum, mantêm-se as Permissões atuais.',
	...
	'FORUM_DESC_EXPLAIN'					=> 'Qualquer código HTML que insiras será visível no fórum tal como vês aqui. A descrição não é exibida caso escolhas o tipo de fórum ser uma categoria.',
	...
	'FORUM_PASSWORD_UNSET_EXPLAIN'	=> 'Seleciona se desejas remover a password do Fórum.',
	...
	'LIMIT_SUBFORUMS_EXPLAIN'			=> 'Limita os sub-fóruns a serem exibidos aos sub-fóruns que são descendentes diretos (filhos) do fórum atual. Desativar isso exibirá todos os sub-fóruns com a opção "Listar sub-fóruns na legenda" ativada, independentemente da profundidade.',
	...
	'MOVE_POSTS_NO_POSTABLE_FORUM'	=> 'O Fórum escolhido para mover as mensagens não pode receber mensagens. Seleciona um Fórum que possa receber mensagens.',
	'MOVE_POSTS_TO'						=> 'Mover Mensagens para',
	'MOVE_SUBFORUMS_TO'					=> 'Mover Sub-fóruns para',

	'NO_DESTINATION_FORUM'				=> 'Não selecionaste nenhum Fórum para mover o conteúdo.',
