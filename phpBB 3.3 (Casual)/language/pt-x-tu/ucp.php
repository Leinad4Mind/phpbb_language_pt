...
$lang = array_merge($lang, [
	'TERMS_OF_USE_CONTENT'	=> 'Ao acederes a “%1$s” (doravante “nós”, “nos”, “nosso”, “%1$s”, “%2$s”), concordas em ficar legalmente vinculado aos termos seguintes. Se não concordares em ficar legalmente vinculado a todos os termos seguintes, por favor, não acedas nem utilizes “%1$s”. Podemos alterar estes termos a qualquer momento e faremos todos os esforços para te informar dessas alterações. No entanto, é da tua responsabilidade rever este documento regularmente, uma vez que a utilização continuada de “%1$s” após a realização de alterações constitui a tua concordância em ficar legalmente vinculado aos termos atualizados e/ou alterados.
	<br><br>
	Os nossos Fóruns utilizam o phpBB (doravante “eles”, “os”, “deles”, “software phpBB”, “www.phpbb.com”, “phpBB Limited”, “Equipas phpBB”), uma solução de fórum disponibilizada ao abrigo da “<a href="https://opensource.org/license/gpl-2-0">GNU General Public License v2</a>” (doravante “GPL”), que pode ser descarregada em <a href="https://www.phpbb.com/">www.phpbb.com</a>. O software phpBB limita-se a facilitar discussões através da Internet; a phpBB Limited não é responsável pelos conteúdos ou condutas permitidos ou proibidos neste site. Para mais informações sobre o phpBB, consulta: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>.
	<br><br>
	Comprometes-te a não publicar material abusivo, obsceno, vulgar, difamatório, odioso, ameaçador, de cariz sexual ou de qualquer outra forma ilegal, seja ao abrigo das leis do teu país, do país onde “%1$s” está alojado ou do direito internacional. Essa conduta pode resultar na tua expulsão imediata e permanente e, se o considerarmos necessário, na notificação do teu fornecedor de serviços de Internet. O endereço IP de todas as mensagens é registado para ajudar a aplicar estas condições.
	<br><br>
	Concordas que “%1$s” se reserva o direito de remover, editar, mover ou encerrar qualquer tópico, a qualquer momento e ao nosso exclusivo critério. Como utilizador, concordas que todas as informações que introduzires podem ser guardadas numa base de dados. Embora estas informações não sejam divulgadas a terceiros sem o teu consentimento, nem “%1$s” nem o phpBB podem ser responsabilizados por qualquer tentativa de intrusão informática que possa comprometer os dados.
	',

	'PRIVACY_POLICY'		=> 'Esta política explica em detalhe como “%1$s” e as respetivas empresas afiliadas (doravante “nós”, “nos”, “nosso”, “%1$s”, “%2$s”) e o phpBB (doravante “eles”, “os”, “deles”, “software phpBB”, “www.phpbb.com”, “phpBB Limited”, “Equipas phpBB”) utilizam as informações recolhidas durante a tua utilização deste site (doravante “as tuas informações”).
	<br><br>
	As tuas informações são recolhidas de duas formas. Quando navegas em “%1$s”, o software phpBB cria vários cookies. Os cookies são pequenos ficheiros de texto guardados nos ficheiros temporários do teu navegador. Os dois primeiros cookies contêm um identificador de utilizador (doravante “user-id”) e um identificador de sessão anónima (doravante “session-id”), ambos atribuídos automaticamente pelo software phpBB. É criado um terceiro cookie depois de consultares tópicos em “%1$s”. Este guarda informações sobre os tópicos que leste, melhorando assim a tua experiência de utilização.
	<br><br>
	Também podemos criar cookies externos ao software phpBB enquanto navegas em “%1$s”. Estes ficam fora do âmbito deste documento, que abrange apenas os cookies criados pelo software phpBB.
	<br><br>
	A segunda forma de recolhermos informações é através do que nos envias. Isto inclui, entre outros: publicar mensagens como utilizador anónimo (doravante “mensagens anónimas”), registares-te em “%1$s” (doravante “a tua conta”) e as mensagens que publicas depois de te registares e enquanto estás ligado (doravante “as tuas mensagens”).
	<br><br>
	A tua conta contém, no mínimo: um nome de utilizador único (doravante “o teu nome de utilizador”), uma senha pessoal utilizada para entrares (doravante “a tua senha”) e um endereço de email válido (doravante “o teu email”). As informações da tua conta em “%1$s” são protegidas pelas leis de proteção de dados aplicáveis no país que nos aloja. Quaisquer informações para além do teu nome de utilizador, senha e endereço de email que sejam solicitadas durante o registo podem ser obrigatórias ou opcionais, segundo o critério de “%1$s”. Em todos os casos, podes escolher as informações da tua conta que serão apresentadas publicamente. Também podes optar por receber ou não os emails gerados automaticamente pelo software phpBB.
	<br><br>
	A tua senha é guardada como um hash unidirecional para garantir a segurança. No entanto, recomendamos que não reutilizes a mesma senha em vários sites. A tua senha é a chave de acesso à tua conta em “%1$s”, por isso, guarda-a em segurança. Em circunstância alguma alguém associado a “%1$s”, ao phpBB ou qualquer terceiro te pedirá legitimamente a tua senha. Se te esqueceres da senha, podes usar a opção “Esqueci-me da senha” disponibilizada pelo software phpBB. Este processo exige que indiques o teu nome de utilizador e endereço de email, após o que o software phpBB irá gerar uma nova senha para recuperares o acesso à tua conta.
	',
]);

// Common language entries
$lang = array_merge($lang, [
	'ACCOUNT_ACTIVE'						=> 'A tua conta foi ativada. Obrigado por te registares.',
	'ACCOUNT_ACTIVE_ADMIN'				=> 'A conta foi ativada.',
	'ACCOUNT_ACTIVE_PROFILE'			=> 'A tua conta foi reativada com sucesso.',
	...
	'ACCOUNT_EMAIL_CHANGED'				=> 'A tua conta foi atualizada. Neste Fórum as alterações de email requerem a reativação. A chave de ativação foi enviada para o teu novo endereço de email. Para mais detalhes verifica o teu endereço de email.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'		=> 'A tua conta foi atualizada. Neste Fórum as alterações de email requerem a reativação por um administrador. Receberás um email quando a tua conta for reativada.',
	'ACCOUNT_INACTIVE'					=> 'A tua conta foi criada com sucesso. A Chave de Ativação foi enviada para o endereço de email que indicaste durante o teu Registo. Ao receberes o email procede à Ativação da tua conta. Só então poderás entrar no Fórum. Se não receberes o email na tua caixa de entrada verifica a caixa de lixo eletrónico. Pode levar algum tempo para obter o e-mail, dependendo do teu provedor de e-mail.',
	'ACCOUNT_INACTIVE_ADMIN'			=> 'A tua conta foi criada. Neste Fórum a ativação da conta é realizada pelo Administrador. Foi-te enviado um email que te informará de Ativar a tua conta. Serás informado após tal, mantém-te atento ao teu email.',
	'ACTIVATION_EMAIL_SENT'				=> 'O email de ativação foi enviado para o teu endereço de email.',
	...
	'ADD_FOES_EXPLAIN'					=> 'Podes introduzir vários Utilizadores, um por linha.',
	'ADD_FOLDER'							=> 'Adicionar Pasta',
	'ADD_FRIENDS'							=> 'Adicionar um novo Amigo',
	'ADD_FRIENDS_EXPLAIN'				=> 'Podes introduzir vários Utilizadores, um por linha.',
	'ADD_NEW_RULE'							=> 'Adicionar nova Regra',
	'ADD_RULE'								=> 'Adicionar Regra',
	'ADD_TO'									=> 'Adicionar [Para]',
	'ADD_USERS_UCP_EXPLAIN'				=> 'Aqui podes adicionar novos utilizadores ao grupo. Podes selecionar se este grupo se torna o novo padrão para os utilizadores selecionados. Por favor, digita um nome de utilizador por cada linha.',
	...
	'ALREADY_ACTIVATED'					=> 'O teu registo já foi ativado.',
	...
	'AVATAR_NOT_ALLOWED'					=> 'O teu avatar não pode ser exibido porque os avatares foram desativados.',
	'AVATAR_PAGE'							=> 'Página',
	'AVATAR_SELECT'						=> 'Seleciona o teu avatar',
	'AVATAR_TYPE'							=> 'Tipo de Avatar',
	'AVATAR_TYPE_NOT_ALLOWED'			=> 'O teu Avatar atual não pode ser exibido porque o teu tipo foi desativado.',

	'BACK_TO_DRAFTS'						=> 'Voltar aos rascunhos guardados',
	'BACK_TO_LOGIN'						=> 'Entrar',
	'BIRTHDAY'								=> 'Aniversário',
	'BIRTHDAY_EXPLAIN'					=> 'O teu aniversário será assinalado na data indicada.',
	'BOARD_DATE_FORMAT'					=> 'O meu formato de data',
	'BOARD_DATE_FORMAT_EXPLAIN'		=> 'A sintaxe usada é idêntica ao da função PHP <a href="https://www.php.net/manual/datetime.format.php">date</a>.',
	'BOARD_LANGUAGE'						=> 'O meu idioma',
	'BOARD_STYLE'							=> 'O Estilo do meu Painel',
	'BOARD_TIMEZONE'						=> 'Fuso Horário',
	'BOOKMARKS'								=> 'Favoritos',
	'BOOKMARKS_EXPLAIN'					=> 'Esta é a tua lista de Favoritos. Para remover da lista um Favorito, seleciona a caixa correspondente e carrega no botão Apagar Favoritos Marcados.',
	'BOOKMARKS_DISABLED'					=> 'Favoritos foram desativados.',
	'BOOKMARKS_REMOVED'					=> 'Os Favoritos selecionados foram apagados com sucesso.',

	'CANNOT_EDIT_MESSAGE_TIME'			=> 'Não podes editar ou apagar a mensagem.',
	'CANNOT_MOVE_TO_SAME_FOLDER'		=> 'Não podem ser movidas mensagens da pasta que queres Apagar.',
	...
	'CLICK_RETURN_FOLDER'				=> 'Clica %1$sAqui%2$s para voltar para a pasta %3$s',
	'CONFIRMATION'							=> 'Confirmação de Registo',
	'CONFIRM_CHANGES'						=> 'Confirmar Alterações',
	'CONFIRM_EXPLAIN'						=> 'Para prevenir Registos automáticos de "espiões" é necessário introduzir um código de confirmação. O código é exibido na imagem que deverás ver em baixo. Se tens alguma deficiência visual, e não podes ler o código, por favor, contacta o %sAdministrador do Fórum%s.',
	...
	'CURRENT_PASSWORD_EXPLAIN'			=> 'Para alterares o teu endereço de email ou nome de utilizador, tens que inserir a tua senha atual.',
	'CURRENT_CHANGE_PASSWORD_EXPLAIN'	=> 'Para alterares a senha, o endereço de email ou o teu nome de utilizador, tens que inserir a tua senha atual.',
	'CUR_PASSWORD_EMPTY'					=> 'Não digitaste a senha atual.',
	'CUR_PASSWORD_ERROR'					=> 'A Senha atual que escreveste está incorreta.',
	...
	'DEFAULT_NOTIFY'						=> 'Observar automaticamente os tópicos e avisar-me sempre que houver respostas novas',
	...
	'DELETE_ATTACHMENT_CONFIRM'		=> 'Tens a certeza que desejas remover este anexo?',
	'DELETE_ATTACHMENTS_CONFIRM'		=> 'Tens a certeza que desejas remover estes anexos?',
	...
	'DELETE_MARKED_PM_CONFIRM'			=> 'Tens a certeza que desejas apagar as Mensagens selecionadas?',
	...
	'DRAFTS_EXPLAIN'						=> 'Aqui podes ver, editar e apagar os rascunhos guardados.',
	...
	'EMPTY_DRAFT'							=> 'Deves escrever uma mensagem antes de enviares as tuas alterações.',
	...
	'FOES_EXPLAIN'						=> 'Inimigos são Utilizadores que serão ignorados. As Mensagens destes Utilizadores não serão totalmente visíveis e as Mensagens Privadas não são autorizadas. No entanto não podes ignorar Administradores ou Moderadores.',
	'FOES_UPDATED'						=> 'A tua Lista de Inimigos foi atualizada com sucesso.',
	'FOLDER_ADDED'						=> 'A Pasta foi adicionada com sucesso.',
	'FOLDER_MESSAGE_STATUS'		=> [
		1	=> '%2$d de %1$s guardada',
		2	=> '%2$d de %1$s guardadas',
	],
	'FOLDER_NAME_EMPTY'				=> 'Tens que atribuir um nome a esta pasta.',
	...
	'FORCE_PASSWORD_EXPLAIN'		=> 'Por motivos de Segurança. É obrigatório que alteres a tua senha.',
	...
	'FRIENDS_UPDATED'					=> 'A tua Lista de Amigos foi atualizada com sucesso.',
	...
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'Especifica a largura e a altura do avatar, deixa em branco para tentar verificação automática.',
	...
	'LINK_REMOTE_AVATAR_EXPLAIN'		=> 'Indica a URL do local que contém a imagem de Avatar que desejas.',
	'LINK_REMOTE_SIZE'					=> 'Dimensões do Avatar',
	'LINK_REMOTE_SIZE_EXPLAIN'			=> 'Especifica a Largura e Altura do Avatar. Deixa espaço em branco para tentar a verificação automática.',
	'LOGIN_EXPLAIN_UCP'					=> 'Tens que estar ligado para entrar no Painel de Controlo do Utilizador.',
	'LOGIN_LINK'							=> 'Entra ou regista-te, usando um serviço externo à tua conta, no Fórum',
	...
	'LOGIN_LINK_MISSING_DATA'			=> 'Os dados necessários para associar a tua conta a um serviço externo não estão disponíveis. Reinicia o processo.',
	...
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'	=> 'Tens a certeza que queres marcar todas as notificações como lidas?',
	...
	'NOTIFICATION_TYPE_REPORT_CLOSED'			=> 'A tua mensagem denunciada foi fechada por um moderador',
	'NOTIFICATION_TYPE_REPORT_PM'					=> 'Alguém denunciou uma mensagem privada',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'		=> 'A tua mensagem privada denunciada foi fechada por um moderador',
	...
	'NOT_ADDED_FRIENDS_ANONYMOUS'		=> 'Não podes adicionar um Visitante à tua Lista de Amigos.',
	'NOT_ADDED_FRIENDS_BOTS'			=> 'Não podes adicionar Motores de Busca à tua lista de amigos.',
	'NOT_ADDED_FRIENDS_FOES'			=> 'Não podes adicionar Inimigos à tua Lista de Amigos.',
	'NOT_ADDED_FRIENDS_SELF'			=> 'Não podes auto adicionar-te à tua Lista de Amigos.',
	'NOT_ADDED_FOES_MOD_ADMIN'			=> 'Não podes adicionar Administradores ou Moderadores à tua Lista de Inimigos.',
	'NOT_ADDED_FOES_ANONYMOUS'			=> 'Não podes adicionar um Visitante à tua Lista de Inimigos.',
	'NOT_ADDED_FOES_BOTS'				=> 'Não podes adicionar Motores de Busca à tua Lista de Inimigos.',
	'NOT_ADDED_FOES_FRIENDS'			=> 'Não podes adicionar Amigos à tua Lista de Inimigos.',
	'NOT_ADDED_FOES_SELF'				=> 'Não podes auto adicionar-te à tua Lista de Inimigos.',
	'NOT_AGREE'								=> 'Li e não concordo com estas condições',
	'NOT_ENOUGH_SPACE_FOLDER'			=> 'A Pasta de Destino “%s” parece estar cheia. O teu pedido não foi executado.',
	'NOT_MOVED_MESSAGES'			=> [
		1	=> 'Tens atualmente %d mensagem privada em espera porque tens a pasta cheia.',
		2	=> 'Tens atualmente %d mensagens privadas em espera porque tens a pasta cheia.',
	],
	...
	'NO_AUTH_PRINT_MESSAGE'				=> 'Não estás autorizado a imprimir mensagens privadas.',
	'NO_AUTH_PROFILEINFO'				=> 'Não estás autorizado a alterar as informações do teu perfil.',
	'NO_AUTH_READ_HOLD_MESSAGE'		=> 'Não estás autorizado a ler Mensagens Privadas que estejam em espera.',
	...
	'NO_AUTH_SIGNATURE'					=> 'Definir a tua Assinatura: Proibido.',

	'NO_BCC_RECIPIENT'					=> 'Nenhum',
	'NO_BOOKMARKS'							=> 'Não tens Favoritos.',
	'NO_BOOKMARKS_SELECTED'				=> 'Não selecionaste nenhum favorito.',
	...
	'NO_FRIENDS'							=> 'Não tens Amigos definidos.',
	...
	'NO_NEW_FOLDER_NAME'					=> 'Deves especificar um novo nome para a pasta.',
	...
	'NO_WATCHED_SELECTED'				=> 'Não selecionaste nenhum Tópico ou Fórum Observado.',
	...
	'PREFERENCES_UPDATED'				=> 'As tuas Preferências foram atualizadas.',
	...
	'PROFILE_UPDATED'						=> 'O teu Perfil foi atualizado.',
	...
	'RELEASE_MESSAGES'					=> 'Clica %saqui%s para libertar as Mensagens em espera, as mesmas serão reorganizadas na pasta apropriada se houver espaço suficiente.',
	'REMOVE_ADDRESS'						=> 'Apagar endereço',
	'REMOVE_SELECTED_BOOKMARKS'			=> 'Apagar Favoritos selecionados',
	'REMOVE_SELECTED_BOOKMARKS_CONFIRM'	=> 'Tens a certeza que desejas remover todos os Favoritos selecionados?',
	'REMOVE_BOOKMARK_MARKED'			=> 'Apagar Favoritos selecionados ',
	'REMOVE_FOLDER'						=> 'Remover pasta',
	'REMOVE_FOLDER_CONFIRM'				=> 'Tens a certeza que desejas remover esta pasta?',
	'RENAME'									=> 'Renomear',
	...
	'RULE_LIMIT_REACHED'					=> 'Não podes adicionar mais regras para as mensagens privadas. Atingiste o número máximo.',
	...
	'SAME_PASSWORD_ERROR'				=> 'A nova Senha introduzida é igual à tua senha atual.',
	...
	'SIGNATURE_EXPLAIN'					=> 'Escreve aqui a Assinatura que por defeito será adicionada a todas a Mensagens. O limite é de %d caracteres.',
	'SIGNATURE_PREVIEW'					=> 'Previsão da Assinatura',
	'SIGNATURE_TOO_LONG'					=> 'A tua Assinatura é muito grande.',
	'SELECT_CURRENT_TIME'				=> 'Seleciona a hora atual',
	'SELECT_TIMEZONE'						=> 'Seleciona o fuso horário',
	'SORT'									=> 'Ordenar',
	...
	'UCP_ADMIN_ACTIVATE'				=> 'Tens de introduzir um endereço de email válido para que o Registo seja ativado. O Administrador verificará o teu Registo, e, se for Aprovado, receberás um email para ativar a tua conta.',
	'UCP_ATTACHMENTS'					=> 'Anexos',
	'UCP_AUTH_LINK'					=> 'Contas externas',
	'UCP_AUTH_LINK_ASK'				=> 'Atualmente não tens nenhuma conta associada a este serviço externo. Clica no botão abaixo para vincular a tua conta no Fórum a uma conta neste serviço externo.',
	...
	'UCP_AUTH_LINK_TITLE'			=> 'Administrar as tuas associações a contas externas',
	...
	'UCP_EMAIL_ACTIVATE'				=> 'Usa um email válido para receberes o email que permitirá ativar a tua conta e entrar no Fórum.',
	...
	'UCP_NOTIFICATION_OPTIONS'				=> 'Editar preferências de notificação',
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Aqui podes definir os teus métodos de notificação preferenciais do Fórum.',
	...
	'UCP_PROFILE'						=> 'Perfil',
	'UCP_PROFILE_AVATAR'				=> 'O teu Avatar',
	'UCP_PROFILE_PROFILE_INFO'		=> 'O teu Perfil',
	'UCP_PROFILE_REG_DETAILS'		=> 'Detalhes do teu Registo',
	'UCP_PROFILE_SIGNATURE'			=> 'A tua assinatura',
	...
	'UCP_PASSWORD_RESET_DISABLED'	=> 'A funcionalidade de alteração da senha foi desativada. Se precisas de ajuda para entrares na tua conta, por favor, contacta o %sAdministrador do Fórum%s',
	'UCP_REGISTER_DISABLE'			=> 'Não é possível criar novos Registos.',
	'UCP_RESEND'						=> 'Enviar email de Ativação',
	'UCP_WELCOME'						=> 'Bem-vindo ao Painel de Controlo do Utilizador. Aqui podes ver e atualizar o teu Perfil, as tuas Preferências, observar Fóruns e Tópicos. Podes enviar Mensagens a outros Utilizadores (se permitido). Verifica se leste todos os anúncios.',
	...
	'UPLOAD_AVATAR_FILE'				=> 'Enviar do teu Computador',
	'UPLOAD_AVATAR_URL'				=> 'Enviar de uma URL',
	'UPLOAD_AVATAR_URL_EXPLAIN'				=> 'Insere a URL da imagem que pretendes usar no Fórum.',
	...
	'WATCHED_EXPLAIN'						=> 'Esta é a lista de Fóruns e Tópicos que estás a observar. Serás avisado de novas Mensagens em cada um deles. Para cancelar a observação, seleciona o Fórum ou Tópico e pressiona o botão <em>Parar de observar selecionados</em>.',
	'WATCHED_FORUMS'						=> 'Fóruns observados',
	'WATCHED_TOPICS'						=> 'Tópicos observados',
	'WRONG_ACTIVATION'					=> 'O código de Ativação que forneceste não coincide com o da Base de Dados.',

	'YOUR_DETAILS'							=> 'A tua Atividade',
	'YOUR_FOES'								=> 'Os teus Inimigos',
	'YOUR_FOES_EXPLAIN'					=> 'Para apagar Utilizadores, seleciona-os e clica em enviar.',
	'YOUR_FRIENDS'							=> 'Os teus Amigos',
	'YOUR_FRIENDS_EXPLAIN'				=> 'Para apagar os Utilizadores, seleciona-os e clica em enviar.',
	'YOUR_WARNINGS'						=> 'O teu número de Avisos',
