...
$lang = array_merge($lang, [
	...
	<br><br>
	Recolheremos informações tuas de duas formas. A primeira, ao navegar no “%1$s” farás com que o Software phpBB crie cookies que são pequenos ficheiros de texto, transferidos temporariamente pelos navegadores web para o teu computador. Os dois primeiros cookies têm a identificação do utilizador (doravante denominado “user-id”) e um identificador de sessão anónima (doravante “session-id”), assinado automaticamente para ti pelo software phpBB. O terceiro cookie será criado sempre que tenha tópicos lidos em “%1$s” e é usado para registar os tópicos lidos, aumentando assim tua experiência como utilizador.
	<br><br>
...
$lang = array_merge($lang, [
	...
	'ACCOUNT_COPPA'						=> 'A tua conta foi criada. Para ser Aprovada é necessário a autorização do seu Encarregado de Educação. Para mais detalhes verifique o seu endereço de email.',
	'ACCOUNT_EMAIL_CHANGED'				=> 'A tua conta foi atualizada. Neste Fórum as alterações de email requerem a reativação. A chave de ativação foi enviada para o seu novo endereço de email. Para mais detalhes verifique o seu endereço de email.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'		=> 'A tua conta foi atualizada. Neste Fórum as alterações de email requerem a reativação por um administrador. Receberá um email quando a sua conta for reativada.',
	...
	'ACCOUNT_INACTIVE_ADMIN'			=> 'A tua conta foi criada. Neste Fórum a ativação da conta é realizada pelo Administrador. Foi-lhe enviado um email que o informará de Ativar a sua conta. Será informado após tal, mantenha-se atento ao seu email.',
	...
	'ADD_USERS_UCP_EXPLAIN'				=> 'Aqui podes adicionar novos utilizadores ao grupo. Pode selecionar se este grupo se torna o novo padrão para os utilizadores selecionados. Por favor, digite um nome de utilizador por cada linha.',
	...
	'BOOKMARKS'								=> 'Favoritos',
	'BOOKMARKS_EXPLAIN'					=> 'Esta é a tua lista de Favoritos. Para remover da lista um Favorito, selecione a caixa correspondente e carregue no botão Apagar Favoritos Marcados.',
	...
	'EDIT_DRAFT_EXPLAIN'					=> 'Aqui podes editar o seu rascunho. Os rascunhos não contêm anexos e informações de votações.',
	...
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Aqui podes definir os seus métodos de notificação preferenciais do Fórum.',
	...
	'UCP_WELCOME'						=> 'Bem-vindo ao Painel de Controlo do Utilizador. Aqui podes ver e atualizar o seu Perfil, as suas Preferências, observar Fóruns e Tópicos. Pode enviar Mensagens a outros Utilizadores (se permitido). Verifique se leu todos os anúncios.',
