...
$lang = array_merge($lang, [
	...
	'ANSWERS_EXPLAIN'				=> 'Introduz respostas corretas, uma por linha.',
	'CONFIRM_QUESTION'			=> 'Pergunta',

	'ANSWER'							=> 'Resposta',
	'EDIT_QUESTION'				=> 'Editar Pergunta',
	'QUESTIONS'						=> 'Perguntas',
	'QUESTIONS_EXPLAIN'			=> 'Para cada submissão ao formulário, onde ativaste o plugin Q&amp;A, será feita uma das perguntas aqui definidas. Para usares este plugin deves definir pelo menos uma pergunta no idioma padrão. As perguntas devem ser de fácil resposta para o teu público alvo, mas sem excederem a capacidade de pesquisa do spambot no Google™. Serão obtidos melhores resultados se usares mais do que uma pergunta e as alterares com regularidade. Ativa a confirmação rigorosa se a tua pergunta se baseia em maiúsculas e minúsculas, pontuação ou espaços em branco.',
