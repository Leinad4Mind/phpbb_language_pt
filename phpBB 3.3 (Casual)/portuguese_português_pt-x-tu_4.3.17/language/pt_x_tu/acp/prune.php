...
$lang = array_merge($lang, [
	'ACP_PRUNE_USERS_EXPLAIN'		=> 'Esta secção permite excluir ou desativar Utilizadores do Fórum. As contas podem ser filtradas de várias maneiras: pela contagem de mensagens, atividade mais recente, etc. Os critérios podem ser combinados para determinar as contas afetadas. Por exemplo, podes selecionar os Utilizadores com menos de 10 mensagens, inativos de 01/01/2002. Usa um * como complemento para campos de texto. Alternativamente, podes não usar a seleção por critérios, introduzindo a lista de Utilizadores (um por linha) no campo de texto. Tem cuidado com este recurso! Depois de excluíres um Utilizador não é possível reverter a ação.',

	'CRITERIA'							=> 'Critérios',

	'DEACTIVATE_DELETE'				=> 'Desativar ou apagar',
	'DEACTIVATE_DELETE_EXPLAIN'	=> 'Escolhe se queres desativar Utilizadores ou excluí-los totalmente. Tem em atenção que os Utilizadores excluídos não podem ser restaurados!',
	'DELETE_USERS'						=> 'Apagar',
	...
	'PRUNE_USERS_LIST_DELETE'		=> 'Se selecionares este critério, os Utilizadores terão as suas contas removidas.',
	'PRUNE_USERS_LIST_DEACTIVATE'	=> 'Se selecionares este critério, os Utilizadores terão as suas contas desativadas.',
...
// Forum Pruning
$lang = array_merge($lang, [
	'ACP_PRUNE_FORUMS_EXPLAIN'		=> 'Aqui podes apagar qualquer Tópico que não tenha sido respondido ou visualizado dentro do número de dias selecionado. Se não escreveres um número, todos os Tópicos serão apagados. Tem em atenção que esta operação não excluirá Tópicos com Votações em Curso ou Tópicos Fixos e Anúncios.',
