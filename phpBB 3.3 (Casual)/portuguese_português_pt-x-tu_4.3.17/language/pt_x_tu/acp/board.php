...
$lang = array_merge($lang, [
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'Este interruptor permite ativar/desativar globalmente a Resposta Rápida em todo o Fórum. Quando estiver ativado, terás ainda de ativar a Resposta Rápida individualmente em cada um dos Fóruns.',
...
$lang = array_merge($lang, [
	...
	'CAPTCHA_UNAVAILABLE'						=> 'O plugin não pode ser selecionado enquanto não preencheres os requisitos necessários.',
...
$lang = array_merge($lang, [
	...
	'LOAD_USER_ACTIVITY_EXPLAIN'			=> 'Mostra o Fórum/Tópico ativo no Perfil do Utilizador e no Painel de Controlo do Utilizador. Desativa esta opção em Fóruns com mais de um milhão de Mensagens.',
	...
	'YES_BIRTHDAYS_EXPLAIN'					=> 'Se desativares esta opção, a lista de aniversariantes não será mostrada. Para que esta opção funcione, a opção de ativar Aniversários também tem de estar ativada.',
...
$lang = array_merge($lang, [
	...
	'FORCE_SERVER_VARS_EXPLAIN'			=> 'Se selecionares Sim, serão usadas as configurações aqui definidas em alternativa aos valores definidos automaticamente.',
