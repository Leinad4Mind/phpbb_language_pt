...
$lang = array_merge($lang, [
	...
	'ACCOUNT_ALREADY_ACTIVATED'		=> 'O teu registo já se encontra ativo.',
	'ACCOUNT_DEACTIVATED'				=> 'O teu registo foi desativado manualmente e apenas pode ser reativado por um Administrador.',
	'ACP'										=> 'Painel de Administração',
	'ACP_SHORT'								=> 'ACP',
	'ACTIVATION_ALREADY_SENT'			=> 'O e-mail de ativação já foi enviado para o teu endereço de e-mail. Podes tentar novamente após 24 horas. Se continuares a ter problemas para ativares a tua conta, entra em contacto com um administrador do fórum.',
	'ACTIVE'									=> 'Ativo',
	'ACTIVE_ERROR'							=> 'Especificaste um Utilizador inativo. Certifica-te que ativaste primeiro a conta via e-mail. Se continuares com problemas, contacta um Administrador.',
	'ADMINISTRATOR'						=> 'Administrador',
	'ADMINISTRATORS'						=> 'Administradores',
	'AGE'										=> 'Idade',
	'AIM'										=> 'AIM',
	'AJAX_ERROR_TITLE'					=> 'Erro AJAX',
	'AJAX_ERROR_TEXT'						=> 'Algo de errado ocorreu enquanto o teu pedido era processado.',
	'AJAX_ERROR_TEXT_ABORT'				=> 'Utilizador abortou pedido.',
	'AJAX_ERROR_TEXT_TIMEOUT'			=> 'O teu pedido expirou; tenta novamente.',
	...
	'AND'										=> 'E',
	'ARE_WATCHING_FORUM'					=> 'Optaste por receber atualizações deste Fórum.',
	'ARE_WATCHING_TOPIC'					=> 'Optaste por receber atualizações deste Tópico.',
	'ASCENDING'								=> 'Crescente',
	'ATTACHMENTS'							=> 'Anexos',
	...
	'AUTH_PROVIDER_OAUTH_RETURN_ERROR'							=> 'O serviço externo retornou um valor incorreto, portanto, a tua solicitação não pode ser processada.',
	...
	'AVATAR_EMPTY_REMOTE_DATA'				=> 'Avatar não foi enviado, por favor, tenta enviar o Ficheiro manualmente.',
	...
	'AVATAR_NO_SIZE'							=> 'Não foi possível obter a largura e a altura do Avatar, por favor, indica-os manualmente.',
	...
	'AVATAR_PHP_SIZE_OVERRUN'				=> 'O Ficheiro do Avatar é demasiado grande, sendo o máximo permitido de envio %1$d %2$s.<br />Por favor, tem em atenção que isto é definido no php.ini e não pode ser alterado.',
	...
	'AVATAR_URL_INVALID'						=> 'A URL que especificaste é inválida.',
	...
	'BAN_TRIGGERED_BY_EMAIL'			=> 'O teu endereço de email foi banido do Fórum.',
	'BAN_TRIGGERED_BY_IP'				=> 'O teu endereço IP foi banido do Fórum.',
	'BAN_TRIGGERED_BY_USER'				=> 'O teu Nome de Utilizador foi banido do Fórum.',
	'BBCODE_GUIDE'							=> 'Guia BBCode',
	'BCC'										=> 'Bcc',
	'BIRTHDAYS'								=> 'Aniversariantes',
	'BOARD_BAN_PERM'						=> 'Foste expulso permanentemente deste Fórum.<br /><br />Por favor, contacta o %2$sAdministrador%3$s para mais informações.',
	'BOARD_BAN_REASON'					=> 'Razão da expulsão: %s',
	'BOARD_BAN_TIME'						=> 'Foste expulso deste Fórum até %1$s.<br /><br />Por favor, contacta o %2$sAdministrador%3$s para mais informações.',
	'BOARD_DISABLE'						=> 'Este Fórum está, de momento, indisponível.',
	'BOARD_DISABLED'						=> 'Este Fórum está atualmente desativado.',
	'BOARD_UNAVAILABLE'					=> 'Este Fórum não se encontra disponível neste momento. Por favor, tenta novamente mais tarde.',
	...
	'CONFIRM_CODE_EXPLAIN'				=> 'As letras são maiúsculas e minúsculas. Escreve-as exatamente como aparecem.',
	'CONFIRM_CODE_WRONG'					=> 'O Código de Confirmação está incorreto.',
	'CONFIRM_OPERATION'					=> 'Desejas continuar com esta operação?',
	'CONFIRM_AVATAR_DELETE' 			=> 'Tens a certeza que desejas apagar este avatar?',
	...
	'COOKIE_CONSENT_INFO'				=> 'Sabe mais',
	'COOKIE_CONSENT_MSG'					=> 'Este site utiliza cookies para te proporcionar uma melhor experiência.',
	...
	'EMAIL_ADDRESS'						=> 'Email',
	'EMAIL_INVALID_EMAIL'				=> 'O endereço de email que introduziste é inválido.',
	...
	'EMPTY_MESSAGE_SUBJECT'				=> 'Precisas de especificar um assunto quando escreveres uma nova mensagem.',
	'ENABLED'								=> 'Ativado',
	'ENCLOSURE'								=> 'Documento anexo',
	'ENTER_USERNAME'						=> 'Introduz o Utilizador',
	...
	'FORM_INVALID'						=> 'O formulário apresentado não era válido. Tenta enviar novamente.',
	'FORUM'								=> 'Fórum',
	'FORUMS'								=> 'Fóruns',
	...
	'FORUM_RULES_LINK'				=> 'Por Favor, clica aqui para ver as regras do Fórum',
	'FROM'								=> 'de',
	...
	'FILESYSTEM_CANNOT_CHANGE_FILE_GROUP'		=> 'Não foi possível alterar o grupo do ficheiro',
	'FILESYSTEM_CANNOT_CHANGE_FILE_PERMISSIONS'	=> 'Não foi possível alterar as permissões do ficheiro',
	'FILESYSTEM_CANNOT_COPY_FILES'				=> 'Não foi possível copiar os ficheiros',
	...
	'FILESYSTEM_CANNOT_DELETE_FILES'			=> 'Não foi possível excluir os ficheiros do sistema',
	'FILESYSTEM_CANNOT_DUMP_FILE'				=> 'Não foi possível descarregar o ficheiro',
	'FILESYSTEM_CANNOT_MIRROR_DIRECTORY'		=> 'Não foi possível espelhar o diretório',
	'FILESYSTEM_CANNOT_RENAME_FILE'				=> 'Não foi possível renomear um ficheiro do sistema',
	'FILESYSTEM_CANNOT_TOUCH_FILES'				=> 'Não foi possível criar ou alterar o registo de data e hora do ficheiro',

	'FTP_FSOCK_HOST'					=> 'Servidor FTP',
	'FTP_FSOCK_HOST_EXPLAIN'		=> 'Servidor FTP utilizado para te ligares ao teu site.',
	'FTP_FSOCK_PASSWORD'				=> 'Senha do FTP',
	'FTP_FSOCK_PASSWORD_EXPLAIN'	=> 'Senha para o teu Nome de Utilizador do FTP.',
	'FTP_FSOCK_PORT'					=> 'Porta FTP',
	'FTP_FSOCK_PORT_EXPLAIN'		=> 'Porta utilizada para te ligares ao teu servidor FTP.',
	'FTP_FSOCK_ROOT_PATH'			=> 'Local do phpBB',
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'Caminho desde a raiz até ao teu Fórum phpBB.',
	...
	'FTP_FSOCK_USERNAME_EXPLAIN'	=> 'Nome de utilizador utilizado para te ligares ao teu servidor.',

	'FTP_HOST'							=> 'Servidor FTP',
	'FTP_HOST_EXPLAIN'				=> 'Servidor FTP utilizado para te ligares ao teu site.',
	'FTP_PASSWORD'						=> 'Senha do FTP',
	'FTP_PASSWORD_EXPLAIN'			=> 'Senha para o Utilizador do teu FTP.',
	'FTP_PORT'							=> 'Porta FTP',
	'FTP_PORT_EXPLAIN'				=> 'Porta utilizada para ligares ao teu servidor FTP.',
	'FTP_ROOT_PATH'					=> 'Local do phpBB',
	'FTP_ROOT_PATH_EXPLAIN'			=> 'Local desde a raiz até ao teu Fórum phpBB.',
	'FTP_TIMEOUT'						=> 'Intervalo FTP',
	'FTP_TIMEOUT_EXPLAIN'			=> 'Tempo, em segundos, que o sistema irá aguardar por uma resposta do teu servidor.',
	'FTP_USERNAME'						=> 'Nome do Utilizador do FTP',
	'FTP_USERNAME_EXPLAIN'			=> 'Nome de Utilizador utilizado para te conectares ao teu servidor.',
	...
	'GROUP_ERR_USERNAME'				=> 'Especifica um nome para o Grupo.',
	...
	'HTTP_HANDLER_NOT_FOUND'			=> 'Não foi possível concluir a operação porque a extensão cURL do PHP e a definição allow_url_fopen do php.ini estão desativadas e não foi encontrado outro processador HTTP.',
	...
	'IP'									=> 'IP',
	'IP_BLACKLISTED'					=> 'O teu endereço de IP %1$s foi expulso porque está na lista negra. Para mais detalhes lê <a href="%2$s">%2$s</a>.',

	'JABBER'								=> 'Jabber',
	'JOINED'								=> 'Registado',
	'JUMP_PAGE'							=> 'Número da página para onde desejas ir.',
	'JUMP_TO'							=> 'Ir para',
	'JUMP_TO_PAGE'						=> 'Ir para a página.',
	'JUMP_TO_PAGE_CLICK'				=> 'Clica para ir para a página…',
	...
	'LOGIN_CONFIRM_EXPLAIN'			=> 'Para prevenir ataques "brute force" o Administrador exige o código de confirmação após sucessivas tentativas falhadas de acesso. O código é exibido na imagem abaixo. Se tiveres problemas em ver esta imagem, por favor, contacta um %sAdministrador%s.', // unused
	'LOGIN_ERROR_ATTEMPTS'			=> 'Excedeste o número máximo de tentativas de acesso. Além do teu nome de Utilizador e Senha tens de resolver o CAPTCHA abaixo',
	...
	'LOGIN_ERROR_PASSWORD'				=> 'A Senha introduzida não está correta, tenta novamente. Se continuares com problemas, contacta um %sAdministrador do Fórum%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'	=> 'Não foi possível converter a tua Senha ao atualizar este Fórum. Por favor, pede uma %snova senha%s. Se continuares com problemas, contacta um %sAdministrador do Fórum%s.',
	'LOGIN_ERROR_USERNAME'				=> 'Especificaste um nome de Utilizador incorreto. Confirma o teu nome de Utilizador e tenta novamente. Se continuares com problemas, por favor, contacta um %sAdministrador do Fórum%s.',
	'LOGIN_FORUM'							=> 'Para veres ou enviares mensagens neste Fórum deves inserir a Senha.',
	'LOGIN_INFO'							=> 'O acesso completo ao Fórum requer um Registo, que demora apenas alguns segundos. Antes de te registares, lê as FAQ, as Condições de Utilização e a Política de Privacidade. Respeita as regras do Fórum.',
	'LOGIN_VIEWFORUM'						=> 'Para ver o conteúdo completo deste Fórum é necessário estar ligado.',
	'LOGIN_EXPLAIN_EDIT'					=> 'Para editares Mensagens neste Fórum tens de estar registado e ligado.',
	'LOGIN_EXPLAIN_VIEWONLINE'			=> 'Para apareceres na lista tens de estar registado e ligado.',
	'LOGIN_REQUIRED'						=> 'Tens que te ligar para realizares esta ação.',
	...
	'NEVER'								=> 'Nunca',
	'NO'									=> 'Não',
	'NO_NOTIFICATIONS'				=> 'Não tens notificações',
	'NOT_ALLOWED_MANAGE_GROUP'		=> 'Não estás autorizado a administrar este grupo do “Painel de Administração”.',
	'NOT_AUTHORISED'					=> 'Não estás autorizado a aceder a esta área.',
	...
	'NOTIFY_ADMIN'							=> 'Por favor, notifica o Administrador ou webmaster deste Fórum.',
	'NOTIFY_ADMIN_EMAIL'					=> 'Por favor, notifica o Administrador ou webmaster deste Fórum: <a href="mailto:%1$s">%1$s</a>',
	'NO_ACCESS_ATTACHMENT'				=> 'Não estás autorizado a aceder a este Ficheiro.',
	'NO_ACTION'								=> 'Nenhuma ação especificada.',
	'NO_ADMINISTRATORS'					=> 'Este Fórum não tem Administradores.',
	'NO_AUTH_ADMIN'						=> 'Não tens permissões de Administrador, logo não podes aceder ao Painel de Administração.',
	'NO_AUTH_ADMIN_USER_DIFFER'		=> 'Não podes autenticar-te novamente com outro nome de utilizador.',
	'NO_AUTH_OPERATION'					=> 'Não tens as permissões necessárias para completares esta operação.',
	...
	'NO_STYLE_DATA'						=> 'Não foi possível obter os dados do estilo para o user_style %s e definido para user_id %s',
	'NO_STYLE_CFG'							=> 'Não foi possível obter o ficheiro de configuração de estilo para: %s',
	...
	'PLEASE_WAIT'					=> 'Por favor, aguarda.',
	'PM'								=> 'MP',
	'PM_REPORTED'					=> 'Clica para ver relatório',
	...
	'POST_BY_AUTHOR'				=> 'por',
	'POST_BY_FOE'					=> '<strong>%1$s</strong>, que atualmente está na tua lista de ignorados, fez esta mensagem.',
	...
	'POST_PCT_ACTIVE_OWN'		=> '%.2f%% das tuas mensagens',
	'POST_REPLY'					=> 'Responder',
	'POST_REPORTED'				=> 'Clica aqui para ver as denúncias',
	...
	'POST_UNAPPROVED_EXPLAIN'	=> 'Esta mensagem não é visível para outros utilizadores até que tenha sido aprovada pelo Staff e Críticos.',
	...
	'REMOVE'							=> 'Remover',
	'REMOVE_INSTALL'				=> 'Apaga, move ou renomeia a pasta de instalação.',
	'REPLIES'						=> 'Respostas',
	...
	'RETURN_INDEX'					=> 'Clica %saqui%s para voltar ao Índice',
	'RETURN_FORUM'					=> 'Clica %saqui%s para voltar ao Fórum',
	'RETURN_PAGE'					=> 'Clica %saqui%s para voltar à página anterior',
	'RETURN_TOPIC'					=> 'Clica %saqui%s para voltar ao Tópico',
	...
	'SELECT_DESTINATION_FORUM'	=> 'Seleciona o Fórum de destino',
	'SELECT_FORUM'					=> 'Seleciona o Fórum',
	...
	'SORRY_AUTH_READ'				=> 'Não estás autorizado a ver este Fórum.',
	'SORRY_AUTH_READ_TOPIC'		=> 'Não estás autorizado a ler este Tópico.',
	'SORRY_AUTH_VIEW_ATTACH'	=> 'Não estás autorizado a transferir este anexo.',
	'SORT_BY'						=> 'Ordenar por',
	...
	'SQL_ERROR_OCCURRED'			=> 'Ocorreu um erro SQL enquanto esta página era processada. Contacta um %sAdministrador do Fórum%s se o problema persistir',
	...
	'TOO_LARGE'						=> 'O valor que inseriste é muito grande.',
	...
	'TOO_MANY_VOTE_OPTIONS'			=> 'Escolheste muitas opções.',
	...
	'TOO_SHORT_EMAIL_CONFIRM'		=> 'A confirmação do endereço de email que digitaste é muito curta.',
	'TOO_SMALL'							=> 'O valor que inseriste é muito pequeno.',
	...
	'TOPIC_LOCKED'						=> 'Este Tópico está bloqueado. Não podes editar mensagens ou responder.',
	...
	'UNABLE_GET_IMAGE_SIZE'				=> 'É impossível aceder ao Ficheiro de imagem, porque não é uma imagem válida. Por favor, verifica se o URL que inseriste está correto.',
	...
	'UNWATCH_FORUM_CONFIRM'				=> 'Tens a certeza que desejas cancelar a assinatura deste fórum?',
	'UNWATCH_FORUM_DETAILED'			=> 'Tens a certeza que desejas cancelar a assinatura do fórum “%s”?',
	'UNWATCH_TOPIC_CONFIRM'				=> 'Tens a certeza que desejas cancelar a assinatura deste Tópico?',
	'UNWATCH_TOPIC_DETAILED'			=> 'Tens a certeza que desejas cancelar a assinatura do Tópico “%s”?',
	...
	'URL_REDIRECT'							=> 'Se o teu navegador não suporta redirecionamentos, %sPor Favor, clica aqui para seres redirecionado%s.',
	'USERGROUPS'							=> 'Grupos',
	'USERNAME'								=> 'Utilizador',
	'USERNAMES'								=> 'Utilizadores',
	'USER_AVATAR'							=> 'Avatar do Utilizador',
	'USER_CANNOT_READ'					=> 'Não podes ler mensagens neste Fórum.',
	'USER_POSTS'			=> [
		1	=> '%d Mensagem',
		2	=> '%d Mensagens',
	],
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> 'Pedimos desculpa, mas não estás autorizado a utilizar esta funcionalidade. Podes ter que estar registado, e ter que participar mais para usares esta funcionalidade.',
	...
	'VIEW_LATEST_POST'					=> 'Vê a última Mensagem',
	...
	'WATCH_FORUM_CONFIRM'			=> 'Tens a certeza que desejas subscrever este Fórum?',
	'WATCH_FORUM_DETAILED'			=> 'Tens a certeza que desejas subscrever o Fórum “%s”?',
	'WATCH_TOPIC_CONFIRM'			=> 'Tens a certeza que desejas subscrever este Tópico?',
	'WATCH_TOPIC_DETAILED'			=> 'Tens a certeza que desejas subscrever o Tópico “%s”?',
