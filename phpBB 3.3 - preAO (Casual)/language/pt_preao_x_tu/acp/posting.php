...
$lang = array_merge($lang, [
	...
	'BBCODE_NOT_EXIST'				=> 'O BBCode que seleccionaste não existe.',
	...
	'tokens'			=> [
		...
		'ALNUM'				=> 'Caracteres do alfabeto latino (A-Z) e números.',
		'CHOICE'			=> 'Uma opção entre valores especificados, por exemplo <samp>{CHOICE=espadas,copas,ouros,paus}</samp>. Por predefinição, os valores não distinguem maiúsculas de minúsculas; a opção <samp>caseSensitive</samp> permite distingui-las: <samp>{CHOICE=Espadas,Copas,Ouros,Paus;caseSensitive}</samp>',
		'FLOAT'				=> 'Um valor decimal, por exemplo <samp>0.5</samp>.',
		'HASHMAP'			=> 'Associa sequências às respectivas substituições no formato <samp>{HASHMAP=sequência1:substituição1,sequência2:substituição2}</samp>. Distingue maiúsculas de minúsculas e, por predefinição, preserva valores desconhecidos.',
		'INT'				=> 'Um valor inteiro, por exemplo <samp>2</samp>.',
		'IP'				=> 'Um endereço IPv4 ou IPv6 válido.',
		'IPPORT'			=> 'Um endereço IPv4 ou IPv6 válido com número de porta.',
		'IPV4'				=> 'Um endereço IPv4 válido.',
		'IPV6'				=> 'Um endereço IPv6 válido.',
		'MAP'				=> 'Associa sequências às respectivas substituições no formato <samp>{MAP=sequência1:substituição1,sequência2:substituição2}</samp>. Não distingue maiúsculas de minúsculas e, por predefinição, preserva valores desconhecidos.',
		'RANGE'				=> 'Aceita um inteiro no intervalo indicado, por exemplo <samp>{RANGE=-10,42}</samp>.',
		'REGEXP'			=> 'Valida o valor através de uma expressão regular, por exemplo <samp>{REGEXP=/^foo\w+bar$/}</samp>.',
		'TIMESTAMP'			=> 'Uma indicação temporal como <samp>1h30m10s</samp>, que será convertida num número de segundos. Também aceita um número.',
		'UINT'				=> 'Um valor inteiro sem sinal. Equivale a <samp>{INT}</samp>, mas rejeita valores inferiores a 0.',
	],
]);
...
$lang = array_merge($lang, [
	...
	'DELETE_DISALLOW_EXPLAIN'		=> 'Aqui podes eliminar uma proibição, ao seleccionar na lista o nome cuja proibição pretendes anular, clicando de seguida em enviar.',
