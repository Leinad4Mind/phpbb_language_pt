...
$lang = array_merge($lang, [
	...
	'ADD_FEEDBACK_EXPLAIN'			=> 'Utiliza o campo abaixo para escrever o relatório. Não é permitida a utilização de HTML, BBCode, etc.',
	'ADD_WARNING'						=> 'Adicionar Explicação',
	'ADD_WARNING_EXPLAIN'			=> 'Podes enviar este aviso para o utilizador em questão com a opção em baixo seleccionada. Se acrescentares texto tem em atenção que HTML, BBCode, etc. não são permitidos.',
	...
	'APPROVE_POST_CONFIRM'			=> 'Desejas aprovar esta Mensagem?',
	'APPROVE_POSTS'					=> 'Aprovar Mensagens',
	'APPROVE_POSTS_CONFIRM'			=> 'Desejas aprovar as Mensagens seleccionadas?',
	'APPROVE_TOPIC'					=> 'Aprovar tópico',
	'APPROVE_TOPIC_CONFIRM'			=> 'Tens a certeza que pretendes aprovar este Tópico?',
	'APPROVE_TOPICS'					=> 'Aprovar tópicos',
	'APPROVE_TOPICS_CONFIRM'		=> 'Tens a certeza que pretendes aprovar os tópicos seleccionados?',

	'CANNOT_MOVE_SAME_FORUM'		=> 'O Tópico já se encontra no Fórum para onde pretendes movê-lo.',
	'CANNOT_WARN_ANONYMOUS'			=> 'Não podes avisar Utilizadores não registados.',
	'CANNOT_WARN_SELF'				=> 'Não podes auto advertir-te.',
	'CAN_LEAVE_BLANK'					=> 'Pode ser deixado em branco.',
	'CHANGE_POSTER'					=> 'Alterar criador da Mensagem',
	'CLOSE_PM_REPORT'					=> 'Fechar denúncia de MP',
	'CLOSE_PM_REPORT_CONFIRM'		=> 'Tens a certeza que desejas fechar a denúncia da MP?',
	'CLOSE_PM_REPORTS'				=> 'Fechar denúncias de MPs',
	'CLOSE_PM_REPORTS_CONFIRM'		=> 'Tens a certeza que desejas fechar as denúncias das MPs?',
	'CLOSE_REPORT'						=> 'Fechar a denúncia',
	'CLOSE_REPORT_CONFIRM'			=> 'Tens a certeza que desejas fechar a denúncia seleccionada?',
	'CLOSE_REPORTS'					=> 'Fechar denúncias',
	'CLOSE_REPORTS_CONFIRM'			=> 'Tens a certeza que desejas fechar as denúncias seleccionadas?',

	'DELETE_PM_REPORT'				=> 'Apagar denúncia de MP',
	'DELETE_PM_REPORT_CONFIRM'		=> 'Tens a certeza que desejas apagar a denúncia da MP?',
	'DELETE_PM_REPORTS'				=> 'Apagar denúncias de MP',
	'DELETE_PM_REPORTS_CONFIRM'	=> 'Tens a certeza que desejas apagar as denúncias das MPs?',
	'DELETE_POSTS'						=> 'Apagar Mensagens',
	'DELETE_REPORT'					=> 'Apagar denúncia',
	'DELETE_REPORT_CONFIRM'			=> 'Tens a certeza que desejas apagar a denúncia seleccionada?',
	'DELETE_REPORTS'					=> 'Apagar denúncias',
	'DELETE_REPORTS_CONFIRM'		=> 'Tens a certeza que desejas apagar as denúncias seleccionadas?',
	...
	'DISAPPROVE_POST_CONFIRM'		=> 'Tens a certeza que desejas cancelar esta Mensagem?',
	'DISAPPROVE_POSTS'				=> 'Cancelar Mensagens',
	'DISAPPROVE_POSTS_CONFIRM'		=> 'Tens a certeza que desejas cancelar as Mensagens seleccionadas?',
	'DISPLAY_LOG'						=> 'Mostrar resultados anteriores',
	'DISPLAY_OPTIONS'					=> 'Opções de exibição',

	'EMPTY_REPORT'							=> 'Tens que introduzir uma descrição quando utilizas este motivo.',
	...
	'FORK_TOPIC_CONFIRM'				=> 'Tens a certeza que desejas copiar este Tópico?',
	'FORK_TOPICS'						=> 'Copiar Tópicos seleccionados',
	'FORK_TOPICS_CONFIRM'			=> 'Tens a certeza que desejas copiar os Tópicos seleccionados?',
	'FORUM_DESC'						=> 'Descrição',
	'FORUM_NAME'						=> 'Nome do Fórum',
	'FORUM_NOT_EXIST'					=> 'O Fórum seleccionado não existe.',
	'FORUM_NOT_POSTABLE'				=> 'Não podes enviar Mensagens nesse Fórum.',
	...
	'LOCK_POST_POSTS_CONFIRM'		=> 'Tens a certeza que desejas bloquear as Mensagens seleccionadas?(Não poderás editá-las futuramente)',
	'LOCK_TOPIC_CONFIRM'				=> 'Tens a certeza que desejas bloquear este Tópico?',
	'LOCK_TOPICS'						=> 'Bloquear Tópicos seleccionados',
	'LOCK_TOPICS_CONFIRM'			=> 'Tens a certeza que desejas bloquear todos os Tópicos seleccionados?',
	...
	'MCP_MAKE_ANNOUNCEMENT_CONFIRM'	=> 'Tens a certeza que desejas alterar este Tópico para anúncio?',
	'MCP_MAKE_ANNOUNCEMENTS'			=> 'Criar anúncios',
	'MCP_MAKE_ANNOUNCEMENTS_CONFIRM'	=> 'Tens a certeza que desejas alterar estes Tópicos para anúncios?',
	'MCP_MAKE_GLOBAL'						=> 'Deixar como anúncio global',
	'MCP_MAKE_GLOBAL_CONFIRM'			=> 'Tens a certeza que desejas alterar este Tópico para anúncio global?',
	'MCP_MAKE_GLOBALS'					=> 'Deixar como anúncios globais',
	'MCP_MAKE_GLOBALS_CONFIRM'			=> 'Tens a certeza que desejas alterar estes Tópicos para anúncios globais?',
	'MCP_MAKE_STICKY'						=> 'Deixar Tópico fixo',
	'MCP_MAKE_STICKY_CONFIRM'			=> 'Tens a certeza que desejas deixar este Tópico fixo?',
	'MCP_MAKE_STICKIES'					=> 'Deixar Tópicos Fixos',
	'MCP_MAKE_STICKIES_CONFIRM'		=> 'Tens a certeza que desejas deixar estes Tópicos fixos?',
	'MCP_MAKE_NORMAL'						=> 'Deixar como Tópico normal',
	'MCP_MAKE_NORMAL_CONFIRM'			=> 'Tens a certeza que desejas deixar este Tópico como Tópico normal?',
	'MCP_MAKE_NORMALS'					=> 'Deixar como Tópicos normais',
	'MCP_MAKE_NORMALS_CONFIRM'			=> 'Tens a certeza que desejas deixar estes Tópicos como Tópicos normais?',
	...
	'MERGE_POSTS_CONFIRM'				=> 'Desejas fundir as Mensagens seleccionadas?',
	'MERGE_TOPIC_EXPLAIN'				=> 'Usa este formulário para fundir Mensagens com Tópicos. Depois de fundidas, as mensagens comportam-se como se tivessem sido enviadas originalmente para o Tópico.<br />Digita a ID do Tópico de destino da mensagem ou clica em “Escolher Tópico” e procura-o na lista.',
	'MERGE_TOPIC_ID'						=> 'ID do Tópico de destino',
	'MERGE_TOPICS'							=> 'Fundir Tópicos',
	'MERGE_TOPICS_CONFIRM'				=> 'Tens a certeza que desejas fundir os Tópicos seleccionados?',
	...
	'MOVE_TOPIC_CONFIRM'					=> 'Tens a certeza que desejas mover este Tópico para um novo Fórum?',
	'MOVE_TOPICS'							=> 'Mover Tópicos seleccionados',
	'MOVE_TOPICS_CONFIRM'				=> 'Tens a certeza que desejas mover estes Tópicos seleccionados para dentro de um novo Fórum?',
	...
	'NO_DESTINATION_FORUM'				=> 'Por Favor, selecciona um Fórum para destino.',
	...
	'NO_FINAL_TOPIC_SELECTED'			=> 'Selecciona o Tópico de destino das Mensagens.',
	'NO_MATCHES_FOUND'					=> 'Nenhum resultado encontrado.',
	'NO_POST'								=> 'Tens que seleccionar a Mensagem cujo conteúdo queres avisar o Utilizador.',
	'NO_POST_REPORT'						=> 'Esta Mensagem não foi relatada.',
	'NO_POST_SELECTED'					=> 'Deves seleccionar pelo menos uma Mensagem para realizar esta acção.',
	...
	'NO_REPORT_SELECTED'					=> 'Deves seleccionar pelo menos uma denúncia para realizar esta acção.',
	'NO_TOPIC_ICON'						=> 'Nenhum',
	'NO_TOPIC_SELECTED'					=> 'Deves seleccionar ao menos um Tópico para realizar esta acção.',
	...
	'REPORT_MESSAGE_EXPLAIN'			=> 'Usa este formulário para denunciar a mensagem privada seleccionada. As denúncias devem apenas ser usadas se a mensagem privada viola as regras do Fórum. <strong> Denunciar uma mensagem privada tornará o seu conteúdo visível para todos os Moderadores.</strong>',
	'REPORT_NOTIFY'						=> 'Notifique-me',
	'REPORT_NOTIFY_EXPLAIN'				=> 'Quando a denúncia for decidida.',
	'REPORT_POST_EXPLAIN'				=> 'Usa este formulário para denunciar mensagens aos administradores e moderadores do Fórum. As mensagens que violem as regras do Fórum devem ser denunciadas.',
	'REPORT_REASON'						=> 'Razão da denúncia',
	'REPORT_TIME'							=> 'Tempo da denúncia',
	'RESTORE'								=> 'Restaurar',
	'RESTORE_POST'							=> 'Restaurar mensagem',
	'RESTORE_POST_CONFIRM'				=> 'Tens a certeza que desejas restaurar esta mensagem?',
	'RESTORE_POSTS'						=> 'Restaurar mensagens',
	'RESTORE_POSTS_CONFIRM'				=> 'Tens a certeza que desejas restaurar estas mensagens?',
	'RESTORE_TOPIC'						=> 'Restaurar tópico',
	'RESTORE_TOPIC_CONFIRM'				=> 'Tens a certeza que desejas restaurar este tópico?',
	'RESTORE_TOPICS'						=> 'Restaurar tópicos',
	'RESTORE_TOPICS_CONFIRM'			=> 'Tens a certeza que desejas restaurar estes tópicos?',
	...
	'SELECT_ACTION'						=> 'Selecciona a acção desejada',
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENT'	=> 'Selecciona o Fórum que desejas exibir este anúncio global.',
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENTS'	=> 'Um ou mais dos Tópicos seleccionados são anúncios globais. Selecciona o Fórum que desejas exibir estes anúncios globais.',
	'SELECT_MERGE'						=> 'Selecciona para fundir',
	'SELECT_TOPICS_FROM'				=> 'Selecciona os Tópicos de',
	...
	'UNLOCK_POST_POST_CONFIRM'		=> 'Tens a certeza que desejas permitir a edição desta Mensagem?',
	'UNLOCK_POST_POSTS'				=> 'Desbloquear Mensagens seleccionadas',
	'UNLOCK_POST_POSTS_CONFIRM'	=> 'Tens a certeza que desejas permitir a edição destas Mensagens?',
	'UNLOCK_TOPIC'						=> 'Desbloquear Tópico',
	'UNLOCK_TOPIC_CONFIRM'			=> 'Tens a certeza que desejas desbloquear este Tópico?',
	'UNLOCK_TOPICS'					=> 'Desbloquear Tópicos seleccionados',
	'UNLOCK_TOPICS_CONFIRM'			=> 'Tens a certeza que desejas desbloquear os Tópicos seleccionados?',
	'USER_CANNOT_POST'				=> 'Não podes enviar Mensagens neste Fórum.',
	'USER_CANNOT_REPORT'				=> 'Não podes denunciar Mensagens neste Fórum.',
	...
	'WARNING_PM_BODY'					=> 'O seguinte é um aviso emitido para ti por um Administrador ou Moderador do Fórum.[quote]%s[quote]',
	...
	'YOU_SELECTED_TOPIC'				=> 'Seleccionaste o Tópico número %d: %s.',
	...
	'report_reasons'					=> [
		...
		'DESCRIPTION'					=> [
			...
			'OTHER'						=> 'Outra. Usa o campo abaixo para especificar a razão',
		],
	],
]);
