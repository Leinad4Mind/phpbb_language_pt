...
$lang = array_merge($lang, [
	'TERMS_OF_USE_CONTENT'	=> 'Ao entrar em “%1$s” (doravante “nós”, “nosso”, “%1$s”, “%2$s”), concorda sujeitar-se aos termos seguintes. Se não concorda em sujeitar-se aos termos seguintes, por favor não entre e/ou utilize “%1$s”. Nós podemos mudar estes termos a qualquer momento e vamos fazer o nosso melhor para mantê-lo informado. No entanto, seria prudente rever regularmente estes termos. O uso continuado de “%1$s” significa que concorda em ser legalmente sujeito a estes termos quando são actualizados e/ou alterados.
	<br><br>
...
$lang = array_merge($lang, [
	...
	'ADD_USERS_UCP_EXPLAIN'				=> 'Aqui podes adicionar novos utilizadores ao grupo. Pode seleccionar se este grupo se torna o novo padrão para os utilizadores seleccionados. Por favor, digite um nome de utilizador por cada linha.',
	...
	'UCP_WELCOME'						=> 'Bem-vindo ao Painel de Controlo do Utilizador. Aqui podes ver e actualizar o seu Perfil, as suas Preferências, observar Fóruns e Tópicos. Pode enviar Mensagens a outros Utilizadores (se permitido). Verifique se leu todos os anúncios.',
