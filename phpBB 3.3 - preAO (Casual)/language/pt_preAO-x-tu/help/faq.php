...
$lang = array_merge($lang, [
	'HELP_FAQ_ATTACHMENTS_ALLOWED_ANSWER'		=> 'Cada Administrador pode activar ou desactivar os tipos de anexos que desejar. Se não tens a certeza sobre o que pode ser enviado, contacta o Administrador para mais informações.',
	...
	'HELP_FAQ_GROUPS_DEFAULT_ANSWER'					=> 'Se és Utilizador de mais de um Grupo de Utilizadores, será determinado qual Cor e Classificação te serão atribuídos por padrão. O Administrador poderá conceder-te a possibilidade de escolheres o teu Grupo Padrão pelo Painel de Utilizadores.',
	'HELP_FAQ_GROUPS_DEFAULT_QUESTION'				=> 'O que é um Grupo Padrão?',
	'HELP_FAQ_GROUPS_MODERATORS_ANSWER'				=> 'Moderadores são os Utilizadores (ou Grupos de Utilizadores) cujo trabalho é supervisionar diariamente o andamento das secções que lhes estejam designadas. Eles possuem o poder de editar ou apagar Mensagens, trancar, destrancar, mover e subdividir Tópicos nas secções onde são Moderadores. Geralmente os Moderadores fiscalizam Mensagens que possam ir Além do Assunto em Discussão ou o uso de material abusivo ou ofensivo.',
	...
	'HELP_FAQ_ISSUES_ADMIN_ANSWER'			=> 'Todos os Utilizadores do Fórum podem usar o formulário “Contacta-nos”, se a opção estiver activada.<br />Os Utilizadores podem usar o link “Equipa”.',
	...
	'HELP_FAQ_LOGIN_REGISTER_CONFIRM_ANSWER'			=> 'Verifica se escreveste correctamente o Nome de Utilizador e a Senha. Se tens a certeza de que estão correctos, tem em atenção um de dois factores. Se a função COPPA (Children\'s Online Privacy Protection Act) estiver activa no Fórum e assinalaste uma idade inferior a 13 anos durante o Registo, então tens que seguir as instruções que recebeste. Se não é este o teu caso, então o teu Registo ainda não se encontra activado. Alguns Fóruns obrigam à activação dos novos Registos. A Activação tanto pode ser feita pelo Administrador como pelo próprio Utilizador, que neste último caso receberá um email para esse efeito. Esta informação é fornecida aos novos Utilizadores durante o Registo. Se recebeste um email, segue as suas instruções. Se não recebeste nenhum email, pode ter sido porque escreveste incorrectamente o endereço de email ou então está considerado como spam pelo teu cliente de email. Se tens a certeza que o endereço de email que forneceste é válido e correcto, tenta contactar o Administrador do Fórum.',
	...
	'HELP_FAQ_PMS_CANNOT_SEND_ANSWER'	=> 'Existem três razões para que tal possa acontecer: Não estás Registado no Fórum e/ou não te encontras Online, o Administrador terá desactivado a opção de Mensagens Privadas em todo o Fórum ou impede-te por algum motivo de enviar Mensagens. Se este último é o teu caso, pergunta ao Administrador qual o motivo, caso realmente não saibas.',
	...
	'HELP_FAQ_POSTING_REPORT_ANSWER'				=> 'Se o Administrador tiver activado esta opção, vai até à mensagem que desejas denunciar e verás um botão que serve para denunciar Mensagens. Clicando ali, serás encaminhado às etapas necessárias para denunciares a mensagem.',
	'HELP_FAQ_POSTING_REPORT_QUESTION'			=> 'Como posso Denunciar Mensagens?',
	'HELP_FAQ_POSTING_SIGNATURE_ANSWER'			=> 'Vai ao Painel de Controlo do Utilizador [UCP] aba Perfil opção A tua assinatura, e adiciona a assinatura pretendida. Ainda no [UCP], no separador Preferências opção Mensagens enviadas selecciona Activar sempre a Minha Assinatura. Nas tuas Mensagens podes, se assim o desejares, desactivar caso a caso a opção Anexar assinatura.',
	...
	'HELP_FAQ_SEARCH_FORUM_ANSWER'			=> 'Escrevendo um Termo de Pesquisa na respectiva página localizada no Índice do Fórum, Visualizando Tópicos ou Secções. Podes aceder à Pesquisa Avançada clicando no atalho Pesquisar que se encontra disponível em todas as páginas do Fórum.',
	...
	'HELP_FAQ_USERSETTINGS_TIMEZONE_ANSWER'			=> 'Se tens a certeza de teres definido o fuso horário correctamente e a hora continua errada, então o horário definido no relógio do servidor está incorrecto. Por favor, contacta o administrador para corrigir o problema.',
