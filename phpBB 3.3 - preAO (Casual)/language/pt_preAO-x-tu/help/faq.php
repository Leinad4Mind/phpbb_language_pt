...
$lang = array_merge($lang, [
	...
	'HELP_FAQ_POSTING_REPORT_ANSWER'				=> 'Se o Administrador tiver activado esta opção, vai até à mensagem que deseja denunciar e verá um botão que serve para denunciar Mensagens. Clicando ali, será encaminhado às etapas necessárias para denunciar a mensagem.',
	'HELP_FAQ_POSTING_REPORT_QUESTION'			=> 'Como posso Denunciar Mensagens?',
	'HELP_FAQ_POSTING_SIGNATURE_ANSWER'			=> 'Vá ao Painel de Controlo do Utilizador [UCP] aba Perfil opção A tua assinatura, e adicione a assinatura pretendida. Ainda no [UCP], no separador Preferências opção Mensagens enviadas selecciona Activar sempre a Minha Assinatura. Nas tuas Mensagens pode, se assim o desejar, desactivar caso a caso a opção Anexar assinatura.',
	'HELP_FAQ_POSTING_SIGNATURE_QUESTION'		=> 'Como posso adicionar uma assinatura às minhas Mensagens?',
	'HELP_FAQ_POSTING_WARNING_ANSWER'			=> 'Leia as Regras do Fórum cuidadosamente e cumpra-as rigorosamente. Por Favor, nota que esta é a decisão do Administrador do Fórum, e o phpBB Limited não tem autoridade nenhuma sobre a advertência enviada.',
