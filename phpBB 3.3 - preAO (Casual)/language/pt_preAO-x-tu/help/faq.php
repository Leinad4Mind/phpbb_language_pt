...
$lang = array_merge($lang, [
	'HELP_FAQ_ATTACHMENTS_ALLOWED_ANSWER'		=> 'Cada Administrador pode activar ou desactivar os tipos de anexos que desejar. Se não tem certeza sobre o que pode ser enviado, contacta o Administrador para mais informações.',
	'HELP_FAQ_ATTACHMENTS_ALLOWED_QUESTION'	=> 'Quais os Anexos que são permitidos no Fórum?',
	'HELP_FAQ_ATTACHMENTS_OWN_ANSWER'			=> 'Para encontrar a lista dos Anexos que já enviou para o Fórum, vai ao Painel de Controlo do Utilizador (UCP), na aba Geral clica em Anexos.',
	...
	'HELP_FAQ_FORMATTING_BBOCDE_ANSWER'				=> 'O BBCode é uma implementação especial do HTML. A possibilidade usar BBCode nas mensagens é determinada pelo Administrador do Fórum. Adicionalmente, podes poderá desactivar o BBCode em cada mensagem, ao seleccionar Desactivar BBCode nesta Mensagem abaixo da caixa principal de cada mensagem. BBCode por si mesmo é similar em estilo ao HTML, as Etiquetas (TAGs) são incluídas entre parêntesis rectos, como por [exemplo], em vez de &lt;exemplo&gt; proporcionando uma maior facilidade na formatação dos textos e mensagens dentro do Fórum. Para mais informações, consulta o Guia BBCode, acessível através de um atalho no Painel de Mensagens.',
	...
	'HELP_FAQ_FORMATTING_ICONS_ANSWER'				=> 'Ícones de Tópicos são imagens que podem ser associados com mensagens para indicar o teu conteúdo. O uso dos ícones de tópicos dependerá das permissões escolhidas pelo administrador do fórum.',
	...
	'HELP_FAQ_FRIENDS_BASIC_ANSWER'		=> 'Pode utilizar esta lista para organizar os outros Utilizadores do Fórum. Os Utilizadores adicionados na tua Lista de Amigos serão listados com o teu Painel de Controlo do Utilizador com acesso rápido para ver teus estados Online e para enviá-los Mensagens Privadas. Se solicitar ao Suporte de Templates, as Mensagens enviadas por estes Utilizadores poderão aparecer em destaque. Se adicionar um Utilizador na tua Lista de Inimigos, então qualquer mensagem enviada por ele, será ocultada de forma padrão.',
	'HELP_FAQ_FRIENDS_BASIC_QUESTION'	=> 'O que é a Lista de Amigos e Inimigos?',
	'HELP_FAQ_FRIENDS_MANAGE_ANSWER'		=> 'Podes adicionar Utilizadores na tua lista de duas formas. Através do Perfil de cada Utilizador, existe um atalho para adicioná-los à tua lista. De maneira alternativa, podes adicionar Utilizadores directamente escrevendo os teus Nomes de Utilizadores. Podes também apagar Utilizadores de tua lista utilizando a mesma página.',
	...
	'HELP_FAQ_GROUPS_DEFAULT_ANSWER'					=> 'Se é Utilizador de mais de um Grupo de Utilizadores, será determinado qual Cor e Classificação te serão atribuídos por padrão. O Administrador poderá te conceder a opção de escolhe do teu Grupo Padrão pelo Painel de Utilizadores.',
	'HELP_FAQ_GROUPS_DEFAULT_QUESTION'				=> 'O que é um Grupo Padrão?',
	'HELP_FAQ_GROUPS_MODERATORS_ANSWER'				=> 'Moderadores são os Utilizadores (ou Grupos de Utilizadores) em que teu trabalho é supervisionar diariamente o andamento das secções que lhes estejam designadas. Eles possuem o poder de editar ou apagar Mensagens, trancar, destrancar, mover e subdividir Tópicos nas secções onde são Moderadores. Geralmente os Moderadores fiscalizam Mensagens que possam ir Além do Assunto em Discussão ou o uso de material abusivo ou ofensivo.',
	...
	'HELP_FAQ_GROUPS_USERGROUPS_JOIN_ANSWER'		=> 'Para se inscrever num Grupo de Utilizadores, clica no atalho de Grupos no topo da página (dependendo do Tema em uso), podendo então ver todos os Grupos. Nem todos os Grupos possuem um acesso aberto, alguns estão fechados e alguns poderão inclusive encontrar-se invisíveis. Se o Grupo se encontrar aberto, poderá solicitar tua inscrição clicando no botão apropriado. O Líder do Grupo de Utilizadores precisará aprovar a tua inscrição, podendo perguntar-te o motivo do mesmo. Por Favor, não insista a um Líder de Grupo caso a tua inscrição seja recusada. Ele deverá informá-lo a respeito de qualquer decisão.',
	...
	'HELP_FAQ_ISSUES_FEATURE_ANSWER'			=> 'Este software foi escrito e licenciado pelo Grupo phpBB. Se acreditas que alguma função pode ser adicionada, ou se queres relatar um erro, por favor visita o site <a href="https://www.phpbb.com/ideas/">phpBB Ideas Centre</a>, onde encontrará recursos para o fazer.',
	'HELP_FAQ_ISSUES_FEATURE_QUESTION'		=> 'Por que não existe a Função X?',
	'HELP_FAQ_ISSUES_LEGAL_ANSWER'			=> 'Contacte o Administrador deste Fórum. Veja no canto superior direito da imagem encontrará um atalho para a lista de Utilizadores onde está o Administrador. Envia-lhe uma Mensagem Privada a expor o assunto.',
	...
	'HELP_FAQ_LOGIN_AUTO_LOGOUT_ANSWER'					=> 'Porque anteriormente assinalou a opção Lembrar-me. Nunca assinalar esta opção se usar um computador acessível a outras pessoas. Isso evita o uso abusivo por terceiros da tua conta. Para que esta opção perca efeito, da próxima vez que sair do Fórum clica em: Sair [ Utilizador ]',
	'HELP_FAQ_LOGIN_AUTO_LOGOUT_QUESTION'				=> 'Por que entro automaticamente no Fórum?',
	'HELP_FAQ_LOGIN_CANNOT_LOGIN_ANSWER'				=> 'Já te Registaste? Deves Registar-te para poderes Entrar no Fórum. Foste expulso? Se foste expulso deverás receber uma Mensagem a informar-te da ocorrência. Se discordares das razões apontadas contacta o Administrador. Se estás registado, não te encontras expulso e mesmo assim não conseguires entrar, verifica se o teu Nome de Utilizador e Senha estão correctos. Normalmente é esse o problema. Se mesmo assim, não encontras uma explicação para a situação, contacta o Administrador porque pode haver alguma configuração errada no Sistema.',
	'HELP_FAQ_LOGIN_CANNOT_LOGIN_ANYMORE_ANSWER'		=> 'É possível que o administrador tem excluído o teu registo por algum motivo. Além disso, há administradores que removem registos de utilizadores que nunca colocaram mensagens, de modo a reduzir o tamanho da Base de Dados. Se isso aconteceu, tenta registar-se novamente e ser participativo no fórum.',
	...
	'HELP_FAQ_LOGIN_DELETE_COOKIES_ANSWER'				=> '“Apagar Cookies” apaga do teu navegador todos os cookies criados pelo phpBB3 e que servem para o manter ligado e autenticado, e permitem o pleno funcionamento das opções activadas pelo Administrador.',
	'HELP_FAQ_LOGIN_DELETE_COOKIES_QUESTION'			=> 'Para que serve a opção “Apagar cookies”?',
	'HELP_FAQ_LOGIN_LOST_PASSWORD_ANSWER'				=> 'A tua Senha não pode ser recuperada, no entanto pode pedir uma nova. Proceda como que se estivesse a entrar no Fórum pela primeira vez. Clica em Entrar e em seguida em Esqueci-me da senha. Siga as instruções, e voltará a entrar no Fórum em poucos minutos, com uma Senha nova.',
	'HELP_FAQ_LOGIN_LOST_PASSWORD_QUESTION'			=> 'Esqueci-me da minha Senha, e agora?',
	'HELP_FAQ_LOGIN_REGISTER_ANSWER'						=> 'Compete ao administrador do fórum decidir se para poder criar mensagens, o registo é obrigatório. No entanto; o registo dá-te acesso a ferramentas adicionais não disponíveis aos visitantes, como definir imagens de avatar, mensagens privadas, e-mail de outros utilizadores, subscrição de Grupos, etc. Leva apenas alguns minutos para se registar, daí ser recomendável que o faça.',
	'HELP_FAQ_LOGIN_REGISTER_CONFIRM_ANSWER'			=> 'Verifica se escreveu correctamente o Nome de Utilizador e a Senha.  Se tens a certeza de que estão correctos tem em atenção um de dois factores. Se a função COPPA (Children\'s Online Privacy Protection Act) estiver activa no Fórum e assinalou uma idade inferior a 13 anos durante o Registo, então tens que seguir as instruções que recebeu. Se não é este o teu caso, então o teu Registo ainda não se encontra activado. Alguns Fóruns obrigam à activação dos novos Registos. A Activação tanto pode ser feita pelo Administrador como pelo próprio Utilizador, que neste último caso receberá um email para esse efeito. Esta informação é fornecida aos novos Utilizadores durante o Registo. Se recebeu um email, segue as tuas instruções. Se não recebeu nenhum email podes ter escrito incorrectamente o endereço de email ou então está considerado como spam pelo teu cliente de email. Se tens certeza que o endereço de email que forneceu é válido e correcto, tenta contactar o Administrador do Fórum.',
	...
	'HELP_FAQ_POSTING_CREATE_ANSWER'		=> 'Isso é fácil, clica no botão Novo Tópico ou Responder. Estes botões só são visíveis nas situações em que está autorizado a fazê-lo.',
	'HELP_FAQ_POSTING_CREATE_QUESTION'	=> 'Como crio um Tópico ou respondo num Fórum?',
	'HELP_FAQ_POSTING_DRAFT_ANSWER'		=> 'Esta opção permite-te arquivar o rascunho da mensagem para enviá-la mais tarde. Para recarregá-lo, vai ao Painel de Controlo do Utilizador [UCP] separador Geral opção Rascunhos Arquivados e segue as opções.',
	'HELP_FAQ_POSTING_DRAFT_QUESTION'	=> 'Para que serve o botão Guardar no Painel de Mensagens?',
	'HELP_FAQ_POSTING_EDIT_DELETE_ANSWER'			=> 'A menos que sejas Administrador ou Moderador, apenas podes editar ou excluir as tuas próprias mensagens. Podes editar a mensagem clicando no botão de edição. Por vezes, apenas o poderá fazer por um período limitado de tempo, após o envio da mensagem. Caso alguém tenha já respondido, encontrará um pequeno texto abaixo da mensagem que reporta o número de vezes que a editou, juntamente com a data e a hora. Isto não aparece apenas caso alguém não tenha respondido. Não aparecerá igualmente se um Administrador ou Moderador editarem a mensagem, embora possam deixar uma nota informar o critério que justificou a edição. Por favor nota que os Utilizadores normais não podem apagar uma mensagem após alguém já ter respondido.',
	'HELP_FAQ_POSTING_EDIT_DELETE_QUESTION'		=> 'Como posso editar ou apagar uma Mensagem?',
	'HELP_FAQ_POSTING_FORUM_RESTRICTED_ANSWER'	=> 'Alguns fórum podem ser restringidos a alguns utilizadores ou grupos. Para ver, ler, enviar mensagem ou efectuar qualquer outra acção, poderá precisar de permissões especiais. Contacte um moderador ou administrador para te garantir o acesso.',
	...
	'HELP_FAQ_POSTING_POLL_ADD_ANSWER'			=> 'O limite de opções das votações é fixado pelo administrador do fórum. Se acha que precisa adicionar mais opções para a tua votação do que o número permitido, contacta o administrador do fórum.',
	'HELP_FAQ_POSTING_POLL_ADD_QUESTION'		=> 'Porque não posso adicionar mais opções nas votações?',
	'HELP_FAQ_POSTING_POLL_CREATE_ANSWER'		=> 'Criar uma votação é fácil. Quando envia um Tópico novo (ou Edita a primeira mensagem de um Tópico, caso tenhas permissão para tal), encontra na parte inferior à caixa principal da mensagem, um painel com o Título Adicionar Votação (se não vê isto, é porque provavelmente não tens permissão para criar Votação ou o Tópico não é de tua autoria). Deves escrever um Título para a Votação e em seguida, escrever pelo menos Duas Opções de Voto (para adicionar uma opção de votação, escreve o que pretende, e clica no botão Adicionar opção de Voto). Deverá também estipular um tempo limite para a Votação, sendo 0 ilimitado. Poderá acontecer de existir um limite no Número de Opções de Voto, estando esse limite ao critério e configuração do Administrador.',
	...
	'HELP_FAQ_POSTING_QUEUE_ANSWER'				=> 'O Administrador pode decidir se na secção em que está postando, as Mensagens precisem ser revisadas ou não. E também é possível que o Administrador O tem adicionado a um Grupo de Utilizadores que precise ter tuas Mensagens aprovadas antes de enviá-las ao Fórum. Por Favor, contacta o Administrador para maiores informações.',
	'HELP_FAQ_POSTING_QUEUE_QUESTION'			=> 'Do que necessita a minha Mensagem para ser Aprovada?',
	'HELP_FAQ_POSTING_REPORT_ANSWER'				=> 'Se o Administrador tiver activado esta opção, vai até à mensagem que desejas denunciar e verá um botão que serve para denunciar Mensagens. Clicando ali, será encaminhado às etapas necessárias para denunciar a mensagem.',
	'HELP_FAQ_POSTING_REPORT_QUESTION'			=> 'Como posso Denunciar Mensagens?',
	'HELP_FAQ_POSTING_SIGNATURE_ANSWER'			=> 'Vá ao Painel de Controlo do Utilizador [UCP] aba Perfil opção A tua assinatura, e adiciona a assinatura pretendida. Ainda no [UCP], no separador Preferências opção Mensagens enviadas selecciona Activar sempre a Minha Assinatura. Nas tuas Mensagens pode, se assim o desejar, desactivar caso a caso a opção Anexar assinatura.',
	'HELP_FAQ_POSTING_SIGNATURE_QUESTION'		=> 'Como posso adicionar uma assinatura às minhas Mensagens?',
	'HELP_FAQ_POSTING_WARNING_ANSWER'			=> 'Lê as Regras do Fórum cuidadosamente e cumpra-as rigorosamente. Por Favor, nota que esta é a decisão do Administrador do Fórum, e o phpBB Limited não tem autoridade nenhuma sobre a advertência enviada.',
	'HELP_FAQ_POSTING_WARNING_QUESTION'			=> 'Porque recebi uma Advertência?',

	'HELP_FAQ_SEARCH_BLANK_ANSWER'			=> 'A tua Pesquisa resultou em inúmeras ocorrências. Usa a Pesquisa Avançada e sê mais específico nos termos escritos e selecciona secções onde possam ser pesquisados.',
	...
	'HELP_FAQ_SEARCH_MEMBERS_ANSWER'			=> 'Entre na Página dos Utilizadores e clica no atalho Pesquisar um Utilizador. Ao seleccionar, segue restritamente às opções descritas na página.',
	...
	'HELP_FAQ_USERSETTINGS_CHANGE_SETTINGS_ANSWER'	=> 'As configurações (depois do Registo) são guardadas numa Base de Dados. Para alterá-las acede ao Painel de Controlo do Utilizador [UCP], aba Perfil. Aí pode alterar os dados do teu Registo.',
	...
	'HELP_FAQ_USERSETTINGS_TIMEZONE_ANSWER'			=> 'Se tem certeza de ter definido o fuso horário correctamente e a hora continua errada, então o horário definido no relógio do servidor está incorrecto. Por favor, contacta o administrador para corrigir o problema.',
