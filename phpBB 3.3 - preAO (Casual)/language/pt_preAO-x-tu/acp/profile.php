...
$lang = array_merge($lang, [
	...
	'EMPTY_USER_FIELD_NAME'				=> 'Por favor, dá um Título ao Campo',
	'ENTRIES'								=> 'Entradas',
	...
	'FIELD_IDENT_ALREADY_EXIST'		=> 'A Identificação do Campo seleccionada já existe. Por Favor, escolhe outro nome.',
	...
	'FIELD_IS_CONTACT_EXPLAIN'			=> 'Campos de contacto são exibidos com na secção contacto do perfil do utilizador e são exibidos de forma diferente no mini-perfil ao lado de mensagens e mensagens privadas. Podes usar <samp>%s</samp> como variável reservada que será substituída por um valor fornecido pelo Utilizador.',
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'		=> 'Se esta opção estiver activa, o campo será exibido apenas no Perfil dos Utilizadores e apenas Administradores e Moderadores poderão visualizar/preencher este campo.',
	...
	'STEP_1_EXPLAIN_CREATE'				=> 'Aqui podes escrever os primeiros parâmetros básicos do teu novo Campo no Perfil. Estas informações são necessárias para a segunda etapa, onde poderás inserir as opções restantes e prever o teu Campo mais adiante.',
	'STEP_1_EXPLAIN_EDIT'				=> 'Aqui podes alterar os parâmetros básicos do teu Campo no Perfil. As opções relevantes são recalculadas na segunda etapa, onde poderás prever e testar as tuas novas configurações.',
	'STEP_1_TITLE_CREATE'				=> 'Adicionar Campo de Perfil',
	'STEP_1_TITLE_EDIT'					=> 'Editar Campo de Perfil',
	'STEP_2_EXPLAIN_CREATE'				=> 'Aqui podes definir algumas opções comuns. Além disso, podes prever o Campo que criaste, visualizando-o enquanto Utilizador. Por favor, testa as tuas configurações para verificares se tudo funciona correctamente.',
	'STEP_2_EXPLAIN_EDIT'				=> 'Aqui podes alterar algumas opções comuns. Além disso, podes prever o Campo alterado, visualizando-o enquanto Utilizador. Por favor, testa as tuas configurações para verificares se tudo funciona correctamente.<br /><strong>Tem em atenção que as alterações nos Campos do Perfil não afectam os Campos existentes preenchidos pelos utilizadores.</strong>',
	'STEP_2_TITLE_CREATE'				=> 'Opções Específicas ao Tipo de Perfil',
	'STEP_2_TITLE_EDIT'					=> 'Opções Específicas ao Tipo de Perfil',
	'STEP_3_EXPLAIN_CREATE'				=> 'Se tiveres mais de um Idioma instalado, deves preencher também os restantes itens de linguagem. Se não o fizeres, será usada a configuração do idioma padrão para esse Campo do Perfil personalizado. Também poderás preencher os restantes itens do idioma.',
	'STEP_3_EXPLAIN_EDIT'				=> 'Se tiveres mais de um Idioma instalado, podes também alterar ou adicionar os restantes itens de linguagem. Se não o fizeres, será usada a configuração do idioma padrão para esse Campo do Perfil personalizado.',
