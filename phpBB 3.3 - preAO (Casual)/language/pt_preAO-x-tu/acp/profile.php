...
$lang = array_merge($lang, [
	...
	'STEP_1_EXPLAIN_CREATE'				=> 'Aqui podes escrever os primeiros parâmetros básicos de seu novo Campo no Perfil. Estas informações são necessárias para a segunda etapa, onde poderá inserir as opções restantes e prever o seu Campo mais adiante.',
	'STEP_1_EXPLAIN_EDIT'				=> 'Aqui podes alterar os parâmetros básicos de seu campo no Perfil. As opções relevantes são recalculadas com a segunda etapa, onde poderá prever e testar as suas novas configurações.',
	'STEP_1_TITLE_CREATE'				=> 'Adicionar Campo de Perfil',
	'STEP_1_TITLE_EDIT'					=> 'Editar Campo de Perfil',
	'STEP_2_EXPLAIN_CREATE'				=> 'Aqui podes definir algumas opções comuns. Além disso, pode prever o Campo o qual gerou, visualizando-o enquanto Utilizador. Por Favor, teste as suas configurações para ver se tudo está funcionando correctamente.',
