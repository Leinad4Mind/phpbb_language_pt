...
$lang = array_merge($lang, [
	...
	'EDIT_DROPDOWN_LANG_EXPLAIN'		=> 'Por Favor, nota que pode alterar os teus textos de Opções e também pode adicionar novas opções ao fim. Não é aconselhável adicionar novas Opções dentre outras opções existentes - isto pode resultar em opções defeituosas exibidas aos utilizadores. Isto pode também acontecer se apagar opções no meio de outras. Excluindo opções do fim, resultará em Utilizadores com este item revertido ao padrão inicial.',
	...
	'STEP_1_EXPLAIN_CREATE'				=> 'Aqui podes escrever os primeiros parâmetros básicos de teu novo Campo no Perfil. Estas informações são necessárias para a segunda etapa, onde poderá inserir as opções restantes e prever o teu Campo mais adiante.',
	'STEP_1_EXPLAIN_EDIT'				=> 'Aqui podes alterar os parâmetros básicos de teu campo no Perfil. As opções relevantes são recalculadas com a segunda etapa, onde poderá prever e testar as tuas novas configurações.',
	'STEP_1_TITLE_CREATE'				=> 'Adicionar Campo de Perfil',
	'STEP_1_TITLE_EDIT'					=> 'Editar Campo de Perfil',
	'STEP_2_EXPLAIN_CREATE'				=> 'Aqui podes definir algumas opções comuns. Além disso, pode prever o Campo o qual gerou, visualizando-o enquanto Utilizador. Por Favor, teste as tuas configurações para ver se tudo está funcionando correctamente.',
	'STEP_2_EXPLAIN_EDIT'				=> 'Aqui podes alterar algumas opções comuns. Além disso, pode prever o Campo alterado, visualizando-o enquanto Utilizador. Por Favor, teste as tuas configurações para ver se tudo está funcionando correctamente.<br /><strong>Por Favor, nota que as alterações no Campos do Perfil não afectará os Campos existentes inseridos pelos teus utilizadores.</strong>',
	'STEP_2_TITLE_CREATE'				=> 'Opções Específicas ao Tipo de Perfil',
	'STEP_2_TITLE_EDIT'					=> 'Opções Específicas ao Tipo de Perfil',
	'STEP_3_EXPLAIN_CREATE'				=> 'Desde que tenhas mais de um Idioma instalado, deves preencher os itens de linguagem restantes também. Se não o fizeres, a configuração de idioma padrão para esse campo de perfil personalizado será usada. Também poderás preencher os itens restantes do idioma.',
