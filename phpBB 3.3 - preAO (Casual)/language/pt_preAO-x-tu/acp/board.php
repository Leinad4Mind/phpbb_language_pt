...
$lang = array_merge($lang, [
	...
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'O assunto da última mensagem será mostrado na lista de fóruns com um link para a mensagem. Não são mostrados assuntos relativos a fóruns protegidos por senha ou inacessíveis ao utilizador.',
	...
	'SITE_HOME_TEXT'						=> 'Texto principal do site',
	'SITE_HOME_TEXT_EXPLAIN'			=> 'Este texto será exibido como um link para a tua página inicial, no breadcrumbs do Fórum. Se não for especificado, o padrão será "Página Principal".',
	'SITE_HOME_URL'						=> 'URL principal do site',
...
// Board Features
$lang = array_merge($lang, [
	'ACP_BOARD_FEATURES_EXPLAIN'	=> 'Aqui podes Activar/Desactivar diversos recursos do phpBB.',
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'Este interruptor permite activar/desactivar globalmente a Resposta Rápida em todo o Fórum. Quando estiver activado, terás ainda de activar a Resposta Rápida individualmente em cada um dos Fóruns.',
...
$lang = array_merge($lang, [
	...
	'ALLOW_AVATARS_EXPLAIN'			=> 'Permitir o uso normal de avatares;<br>Caso desactives o uso normal de avatares ou um uso de avatares, os avatares desactivados deixarão de ser visíveis no Fórum, embora os utilizadores possam transferir os seus próprios avatares no Painel de Controlo do Utilizador.',
	'ALLOW_GRAVATAR'					=> 'Activar Avatares de Gravatar',
	'ALLOW_LOCAL'						=> 'Permitir Galeria de Avatares',
	'ALLOW_REMOTE'						=> 'Activar Avatar Remoto',
	'ALLOW_REMOTE_EXPLAIN'			=> 'Os Avatares utilizados de outros sites.<br><em><strong class="error">Aviso:</strong> A activação deste recurso pode permitir que os utilizadores verifiquem a existência de ficheiros e serviços que só podem ser acedidos na rede local.</em>',
	'ALLOW_REMOTE_UPLOAD'			=> 'Permitir o envio de avatar remoto',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Permitir o envio de avatares de um outro site.<br><em><strong class="error">Aviso:</strong> A activação deste recurso pode permitir que os utilizadores verifiquem a existência de ficheiros e serviços que só podem ser acedidos na rede local.</em>',
...
$lang = array_merge($lang, [
	...
	'ALLOW_FLASH_PM_EXPLAIN'			=> 'Para enviar Flash nas Mensagens Privadas tens que activar esta opção. O que depende das tuas Permissões.',
	...
	'FULL_FOLDER_ACTION_EXPLAIN'		=> 'Define o procedimento para quando a pasta do Utilizador atingir o seu limite e a acção configurada não for aplicável. Na pasta "Mensagens enviadas" serão sempre excluídas as Mensagens mais antigas.',
...
$lang = array_merge($lang, [
	...
	'MAX_POST_FONT_SIZE_EXPLAIN'		=> 'Tamanho máximo do tipo de letra numa mensagem, sendo 0 = ilimitado.',
	'MAX_POST_IMG_HEIGHT'				=> 'Altura máxima do flash por Mensagem',
	'MAX_POST_IMG_HEIGHT_EXPLAIN'		=> 'Altura máxima do flash nas Mensagens, sendo 0 = ilimitado.',
	'MAX_POST_IMG_WIDTH'					=> 'Largura máxima do flash por Mensagem',
	'MAX_POST_IMG_WIDTH_EXPLAIN'		=> 'Largura máxima do ficheiro flash nas Mensagens, sendo 0 = ilimitado.',
	'MAX_POST_URLS'						=> 'Número máximo de URLs por Mensagem',
	'MAX_POST_URLS_EXPLAIN'				=> 'Número máximo de URLs que podem ser inseridas numa mensagem, sendo 0 = ilimitado.',
...
$lang = array_merge($lang, [
	...
	'ACC_ACTIVATION_EXPLAIN'				=> 'Podes desactivar os Registos ou definir se o novo Utilizador tem acesso imediato ao Fórum ou se é necessária uma confirmação.',
	'ACC_ACTIVATION_WARNING'				=> 'Por favor, tem em atenção que o método de activação seleccionado actualmente exige que o envio de emails esteja activado, de outra forma de registo será desactivado. Recomendamos que selecciones um método de activação diferente ou actives o envio de emails.',
	'NEW_MEMBER_POST_LIMIT'					=> 'Limite das Mensagens dos Utilizadores Registados Recentemente',
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'		=> 'Os novos utilizadores entram para o Grupo <em>Utilizadores Registados Recentemente</em> até atingirem este número de mensagens. Podes usar este Grupo para impedir que usem as mensagens privadas ou para reveres as suas mensagens. <strong>0 para desactivar.</strong>',
	...
	'PASSWORD_LENGTH_EXPLAIN'		=> 'Número mínimo de caracteres nas senhas. De salientar que o número máximo não é limitado.',
...
$lang = array_merge($lang, [
	...
	'ACP_FEED_HTTP_AUTH_EXPLAIN'			=> 'Permite aos utilizadores aceder a conteúdo oculto para os visitantes, adicionando o parâmetro <samp>auth=http</samp> ao URL do feed. Nota que algumas configurações do PHP podem exigir alterações adicionais ao ficheiro .htaccess. Consulta esse ficheiro para obter orientações. A autenticação HTTP só é compatível com ligações encriptadas (https).',
	...
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'			=> 'O conteúdo destes <strong>não será incluído nos feeds</strong>. Não selecciones nenhum Fórum, para puxar os dados de todos os Fóruns.<br>Selecciona/Desmarca múltiplos Fóruns clicando <samp>CTRL</samp> e clicando.',
]);

// Visual Confirmation Settings
$lang = array_merge($lang, [
	'ACP_VC_SETTINGS_EXPLAIN'					=> 'Aqui podes seleccionar e configurar plugins desenhados para bloquear registos automáticos de spambots. Estes plugins fazem um teste ao utilizador <em>(CAPTCHA)</em> de difícil resolução pelos computadores.',
	'ACP_VC_EXT_GET_MORE'						=> 'Para plugins anti-spam adicionais (e possivelmente melhores), visita o <a href="https://www.phpbb.com/go/anti-spam-ext"><strong>Repositório de Extensões do phpBB.com</strong></a>. Para mais informações sobre a prevenção de spam no teu fórum, visita o <a href="https://www.phpbb.com/go/anti-spam"><strong>phpBB.com Knowledge Base</strong></a>.',
	'AVAILABLE_CAPTCHAS'							=> 'Plugins disponíveis',
	'CAPTCHA_UNAVAILABLE'						=> 'O plugin não pode ser seleccionado enquanto não preencheres os requisitos necessários.',
	'CAPTCHA_GD'									=> 'Imagem GD',
	'CAPTCHA_GD_3D'								=> 'Imagem GD 3D',
	'CAPTCHA_GD_FOREGROUND_NOISE'				=> 'Ruído em primeiro plano',
	'CAPTCHA_GD_EXPLAIN'							=> 'Usa o GD para ser gerada uma imagem anti-spambot mais complexa.',
	'CAPTCHA_GD_FOREGROUND_NOISE_EXPLAIN'	=> 'Usa o ruído em primeiro plano para ser gerada uma imagem GD de mais difícil leitura.',
	'CAPTCHA_GD_X_GRID'							=> 'O ruído de fundo do eixo x',
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> 'Utiliza esta configuração para gerar uma imagem mais complexa. 0 desactiva o ruído de fundo no eixo X.',
	'CAPTCHA_GD_Y_GRID'							=> 'O ruído de fundo do eixo y',
	'CAPTCHA_GD_Y_GRID_EXPLAIN'				=> 'Utiliza esta configuração para gerar uma imagem mais complexa. 0 desactiva o ruído de fundo no eixo Y.',
	...
	'CAPTCHA_CONFIGURE_EXPLAIN'				=> 'Altera as definições do plugin seleccionado.',
...
$lang = array_merge($lang, [
	...
	'COOKIE_NOTICE_EXPLAIN'					=> 'Se activado, um aviso sobre o cookie será mostrado aos utilizadores quando estes visitarem o teu fórum. Poderá ser exigido por lei, dependendo do conteúdo do fórum e das extensões activadas.',
	...
	'COOKIE_SECURE_EXPLAIN'					=> 'Se o Servidor funcionar por SSL, muda para Activado; caso contrário, deixa-o Desactivado. Estando Activado sem funcionar por SSL poderá resultar em erros no Servidor durante os redirecionamentos.',
...
// Contact Settings
$lang = array_merge($lang, [
	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> 'Aqui podes activar e desactivar a página de contacto e adicionar o texto que será exibido.',

	'CONTACT_US_ENABLE'						=> 'Activar página de contacto',
	'CONTACT_US_ENABLE_EXPLAIN'			=> 'Esta página permite aos utilizadores enviarem emails para os administradores do fórum. Tem em atenção que a opção do correio electrónico do fórum tem de estar activa. Poderás encontrar essa opção em Geral &gt; Comunicação do Cliente &gt; Configuração de Email.',
...
// Load Settings
$lang = array_merge($lang, [
	'ACP_LOAD_SETTINGS_EXPLAIN'			=> 'Aqui podes activar e desactivar certas funções do Fórum que podem reduzir o total de processamento pedido. Para a maioria dos Servidores não é necessário desactivar nenhuma função. No entanto, em certos sistemas ou em ambientes de hospedagem compartilhada, pode ser útil desactivares alguns recursos que não sejam realmente necessários. Podes também especificar limites para a carga do sistema e activar sessões, além das quais o Fórum sairá do ar.',

	'ALLOW_CDN'									=> 'Permitir o uso de redes de entrega de conteúdo de terceiros',
	'ALLOW_CDN_EXPLAIN'						=> 'Se esta configuração for activada, alguns ficheiros podem ser colocados em servidores externos em vez do teu próprio servidor. Isso reduz o consumo da largura de banda da rede usada pelo teu servidor, mas pode representar um problema de privacidade em alguns países. Numa instalação padrão do phpBB, isso inclui carregar “jQuery” e o tipo de letra “Open Sans” da rede de entrega de conteúdo da Google. Isso também se aplica ao tipo de letra “Font Awesome”, que o phpBB e algumas extensões usam para renderizar ícones.',
	...
	'LOAD_USER_ACTIVITY_EXPLAIN'			=> 'Mostra o Fórum/Tópico activo no Perfil do Utilizador e no Painel de Controlo do Utilizador. Desactiva esta opção em Fóruns com mais de um milhão de Mensagens.',
	...
	'YES_BIRTHDAYS_EXPLAIN'					=> 'Se desactivares esta opção, a lista de aniversariantes não será mostrada. Para que esta opção funcione, a opção de activar Aniversários também tem de estar activada.',
...
$lang = array_merge($lang, [
	...
	'AUTH_PROVIDER_OAUTH_ERROR_ELEMENT_MISSING'	=> 'Tens de indicar a key e o secret de cada OAuth service provider activado. É necessário apenas uma de cada OAuth service provider.',
	...
	'LDAP_PORT_EXPLAIN'						=> 'Opcionalmente, podes definir uma porta para o Servidor LDAP, que tem como padrão a porta 389.',
	...
	'LDAP_USER_FILTER_EXPLAIN'				=> 'Podes optar por aumentar o limite de objectos pesquisados com filtros adicionais. Por exemplo, <samp>objectClass=posixGroup</samp> deve resultar na utilização de <samp>(&amp;(uid=$username)(objectClass=posixGroup))</samp>.',
]);

// Server Settings
$lang = array_merge($lang, [
	'ACP_SERVER_SETTINGS_EXPLAIN'			=> 'Aqui são definidas as configurações dos Servidores e Domínios. Certifica-te de que os dados estão correctos. Eventuais erros resultará em emails com informações incorrectas. Quando introduzires o domínio, inclui o https:// ou outro protocolo. Altera apenas o número da Porta do Servidor se souberes que o teu Servidor usa um valor diferente, a Porta 80 é usada na maioria dos casos.',

	'ENABLE_GZIP'								=> 'Activa Compressão GZip',
	'ENABLE_GZIP_EXPLAIN'					=> 'Conteúdo gerado será comprimido antes de enviar ao utilizador. Isto pode reduzir o tráfego na rede, mas aumentará o uso do CPU no servidor e cliente. Requer a utilização da extensão PHP zlib.',
	'FORCE_SERVER_VARS'						=> 'Forçar configurações da URL do Servidor',
	'FORCE_SERVER_VARS_EXPLAIN'			=> 'Se seleccionares Sim, serão usadas as configurações aqui definidas em alternativa aos valores definidos automaticamente.',
	...
	'MOD_REWRITE_ENABLE_EXPLAIN' 			=> 'Quando activado, as URLs que contenham ’app.php’ serão reescritas para remover o nome do ficheiro (ou seja, app.php/foo transforma-se em /foo). <strong>O mod_rewrite tem que estar activado no Servidor Apache. Activar esta opção sem o mod_rewrite, poderá comprometer o funcionamento do teu Fórum.</strong>',
	'MOD_REWRITE_DISABLED'					=> 'O módulo <strong>mod_rewrite</strong> está desactivado no teu servidor web Apache. Activa o módulo ou entra em contacto com o teu serviço de hospedagem web, para activarem este recurso.',
	'MOD_REWRITE_INFORMATION_UNAVAILABLE'	=> 'É impossível determinar se este servidor suporta regravação de URL. A configuração pode estar activada, mas se a regravação não estiver disponível os caminhos gerados por este fórum (para uso em links) podem não funcionar. Contacta o teu fornecedor de hospedagem web, se não tiveres a certeza se podes ou não activar com segurança este recurso.',
...
$lang = array_merge($lang, [
	...
	'ALLOW_AUTOLOGIN_EXPLAIN'				=> 'Permite aos Utilizadores entrarem automaticamente quando regressam ao Fórum.',
	'ALLOW_PASSWORD_RESET'					=> 'Permitir redefinição de senha ("Esqueci-me da senha")',
	'ALLOW_PASSWORD_RESET_EXPLAIN'		=> 'Determina se os utilizadores podem usar a opção "Esqueci-me da senha" na página de acesso para recuperar a sua conta. Se usares um mecanismo de autenticação externo, poderás desactivar este recurso.',
	'AUTOLOGIN_LENGTH'						=> 'Duração em dias da chave "Lembrar o meus acesso"',
	'AUTOLOGIN_LENGTH_EXPLAIN'				=> 'Duração da chave "Lembrar o meu acesso" em dias. 0 para desactivar.',
	...
	'FORM_TIME_MAX_EXPLAIN'					=> 'Tempo máximo para enviar formas. Usa -1 para desactivar. Tem em atenção que um formulário pode tornar-se inválido se a sessão expirar.',
	...
	'IP_LOGIN_LIMIT_USE_FORWARDED_EXPLAIN'	=> 'Em vez de limitar as tentativas de acesso pelo endereço IP, são limitadas por valores <var>X_FORWARDED_FOR</var>. <br><em><strong>Aviso:</strong> Só activa esta opção se o servidor proxy fornecer valores <var>X_FORWARDED_FOR</var> confiáveis.</em>',
	...
	'UPLOAD_CERT_VALID_EXPLAIN'			=> 'Se activado, os certificados de uploads remotos serão validados. Isto requer que o pacote CA seja definido pelo ficheiro <samp>openssl.cafile</samp> ou pela configuração do <samp>curl.cainfo</samp> no teu php.ini.',
]);

// Email Settings
$lang = array_merge($lang, [
	'ACP_EMAIL_SETTINGS_EXPLAIN'			=> 'Esta informação é usada quando o Fórum envia emails aos Utilizadores. Certifica-te que usas um email válido. Qualquer Mensagem incorrecta não será entregue neste endereço. Se o teu serviço de hospedagem não oferece um serviço nativo de email baseado no PHP, podes enviar mensagens através de SMTP. É necessário um Servidor adequado, não especifiques qualquer nome antigo aqui! Se o servidor requer autenticação, introduz os nomes e senhas necessários. Tem em atenção que apenas é usada a autenticação básica. Implementações de autenticações diferentes não estão disponíveis.',
	...
	'SMTP_AUTH_METHOD_EXPLAIN'				=> 'Apenas usado se um Nome/Senha é atribuído, pergunte ao teu ISP se não sabe que método usa.',
	...
	'TEST_EMAIL_SENT'							=> 'O email de teste foi enviado.<br>Caso não o recebas, por favor, verifica a tua configuração.<br><br>Caso necessites de assistência, visita o <a href="https://www.phpbb.com/community/">Fórum Oficial de Suporte phpBB</a> (em inglês) ou leinad4mind.top/forum (em português).',
...
$lang = array_merge($lang, [
	...
	'JAB_PORT_EXPLAIN'						=> 'Deixa em branco se souberes que a porta usada é 5222. Caso contrário, coloca a porta correcta',
