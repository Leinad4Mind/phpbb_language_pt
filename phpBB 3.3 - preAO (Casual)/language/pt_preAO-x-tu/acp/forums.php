...
$lang = array_merge($lang, [
	...
	'COPY_PERMISSIONS_EXPLAIN'			=> 'Para facilitar a configuração das permissões do teu novo Fórum, poderá copiar as permissões de um Fórum já existente.',
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'No phpBB3 tudo é baseado em Fóruns que podem ser de três tipos: Categoria, Fórum e Atalho. O Fórum pode ter um número ilimitado de Sub-fóruns, podendo o Administrador decidir o que cada um pode receber. Aqui podes adicionar, editar, apagar, trancar e destrancar Fóruns individuais e ainda adicionar controlos. Se as tuas Mensagens e Tópicos não estão sincronizadas, pode ressincronizar um Fórum. <strong>Os Fóruns criados só se tornam visíveis aos Utilizadores depois de definidas ou copiadas as Permissões adequadas.</strong>',
	...
	'FORUM_DELETE_EXPLAIN'				=> 'Esta ferramenta permite-te apagar um determinado Fórum. Se este, for um Fórum com um elevado número de mensagens, pode se desejar mover, todas as suas mensagens (ou Fóruns) incluídas.',
	...
	'FORUM_EDIT_EXPLAIN'					=> 'Esta ferramenta permite-te criar um novo Fórum. Tenha em atenção que a Moderação e o Controlo do Contador de Mensagens são determinados pelas Permissões do Fórum para cada Utilizador ou Grupo.',
	...
	'FORUM_RULES_LINK_EXPLAIN'			=> 'Escreve aqui o URL da página das regras do Fórum. Esta configuração irá substituir o texto que escreveu das regras do Fórum.',
	...
	'FORUM_WITH_SUBFORUMS_NOT_TO_LINK'	=> 'Está a tentar modificar um Fórum com Sub-fóruns para um atalho. Por favor, move todos os Sub-fóruns deste Fórum antes de continuar, caso não movas os Sub-fóruns e faças a modificação para atalho todos os Sub-fóruns ficarão indisponíveis.',
