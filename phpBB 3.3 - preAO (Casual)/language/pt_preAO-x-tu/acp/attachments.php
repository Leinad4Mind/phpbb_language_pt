...
$lang = array_merge($lang, [
	...
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'Aqui podes adicionar, excluir, modificar e desactivar as Extensões. Consulta o Painel Gestor de Grupos de Extensões. Recomenda-se que não permitas extensões de scripts (tipo: php, php3, php4, phtml, pl, cgi, py, rb, asp, aspx, entre outras...), por serem potencialmente perigosas.',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'			=> 'Dimensões máximas das imagens anexadas. O phpBB pode tentar redimensionar automaticamente as imagens antes do envio para que respeitem estas dimensões. Define ambos os valores como 0px por 0px para desactivar a verificação de dimensões e o redimensionamento automático.',
