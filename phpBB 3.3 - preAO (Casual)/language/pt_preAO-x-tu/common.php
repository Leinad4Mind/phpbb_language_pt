...
$lang = array_merge($lang, [
	...
	'ACCOUNT_ALREADY_ACTIVATED'		=> 'O teu registo já se encontra activo.',
	'ACCOUNT_DEACTIVATED'				=> 'O teu registo foi desactivado manualmente e apenas pode ser reactivado por um Administrador.',
	'ACP'										=> 'Painel de Administração',
	'ACP_SHORT'								=> 'ACP',
	'ACTIVATION_ALREADY_SENT'			=> 'O e-mail de activação já foi enviado para o teu endereço de e-mail. Podes tentar novamente após 24 horas. Se continuares a ter problemas para activar a tua conta, entra em contacto com um administrador do fórum.',
	'ACTIVE'									=> 'Activo',
	'ACTIVE_ERROR'							=> 'Especificaste um Utilizador inativo. Certifica-te que activaste primeiro a conta via e-mail. Se continuares com problemas, contacta um Administrador.',
	...
	'AND'										=> 'E',
	'ARE_WATCHING_FORUM'					=> 'Optaste por receber actualizações deste Fórum.',
	'ARE_WATCHING_TOPIC'					=> 'Optaste por receber actualizações deste Tópico.',
	'ASCENDING'								=> 'Crescente',
	'ATTACHMENTS'							=> 'Anexos',
	...
	'AUTH_PROVIDER_OAUTH_RETURN_ERROR'							=> 'O serviço externo retornou um valor incorrecto, portanto, a tua solicitação não pode ser processada.',
	...
	'AVATAR_NO_UPLOAD_PATH'					=> 'O envio do avatar está activado, mas o caminho de armazenamento do avatar não está configurado.',
	...
	'CONFIRM_CODE_EXPLAIN'				=> 'As letras são maiúsculas e minúsculas. Escreve-as exactamente como aparecem.',
	...
	'FTP_FSOCK_HOST_EXPLAIN'		=> 'Servidor FTP utilizada para se ligar ao teu site.',
	...
	'FTP_FSOCK_PORT_EXPLAIN'		=> 'Porta utilizada para se ligar ao teu servidor FTP.',
	...
	'FTP_FSOCK_USERNAME_EXPLAIN'	=> 'Nome de utilizador utilizado para se ligar ao teu servidor.',

	'FTP_HOST'							=> 'Servidor FTP',
	'FTP_HOST_EXPLAIN'				=> 'Servidor FTP utilizado para se ligar ao teu site.',
	'FTP_PASSWORD'						=> 'Senha do FTP',
	'FTP_PASSWORD_EXPLAIN'			=> 'Senha para de Utilizador do teu FTP.',
	'FTP_PORT'							=> 'Porta FTP',
	'FTP_PORT_EXPLAIN'				=> 'Porta utilizada para ligar ao teu servidor FTP.',
	...
	'FTP_USERNAME_EXPLAIN'			=> 'Nome de Utilizador utilizado para se conectar ao teu servidor.',
	...
	'LOGIN_ERROR_PASSWORD'				=> 'A Senha introduzida não está correcta, tenta novamente. Se continuares com problemas, contacta um %sAdministrador do Fórum%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'	=> 'Não foi possível converter a tua Senha ao actualizar este Fórum. Por favor, pede uma %snova senha%s. Se continuares com problemas, contacta um %sAdministrador do Fórum%s.',
	'LOGIN_ERROR_USERNAME'				=> 'Especificaste um nome de Utilizador incorrecto. Confirma o teu nome de Utilizador e tenta novamente. Se continuares com problemas, por favor, contacta um %sAdministrador do Fórum%s.',
	...
	'LOGIN_EXPLAIN_EDIT'					=> 'Para editar Mensagens neste Fórum tens de estar registado e ligado.',
	'LOGIN_EXPLAIN_VIEWONLINE'			=> 'Para aparecer na lista tens de estar registado e ligado.',
	'LOGIN_REQUIRED'						=> 'Tens que ligar-te para realizar esta acção.',
	...
	'NOTIFICATION_TOPIC_APPROVED'		=> '<strong>Tópico Aprovado, será Movido brevemente.</strong>:',
	...
	'NO_AUTH_OPERATION'					=> 'Não tens as permissões necessárias para completar esta operação.',
	...
	'POST_BY_AUTHOR'				=> 'por',
	'POST_BY_FOE'					=> '<strong>%1$s</strong>, que actualmente está em tua lista de ignorados, fez esta mensagem.',
	...
	'SELECT_DESTINATION_FORUM'	=> 'Selecciona o Fórum de destino',
	'SELECT_FORUM'					=> 'Selecciona o Fórum',
	...
	'UNABLE_GET_IMAGE_SIZE'				=> 'É impossível aceder ao Ficheiro de imagem, porque não é uma imagem válida. Por favor, verifica se o URL que inseriste está correcto.',
	...
	'URL_REDIRECT'							=> 'Se o teu navegador não suporta redireccionamentos, %sPor Favor, clica aqui para ser redireccionado%s.',
	'USERGROUPS'							=> 'Grupos',
	'USERNAME'								=> 'Utilizador',
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> 'Pedimos desculpa, mas não estás autorizado a utilizar esta funcionalidade. Podes ter que estar registado, e ter que participar mais para usar esta funcionalidade.',
