...
$lang = array_merge($lang, [
	...
	'ACTIVE'									=> 'Activo',
	'ACTIVE_ERROR'							=> 'Especificaste um Utilizador inactivo. Certifica-te que activaste primeiro a conta via e-mail. Se continuares com problemas, contacta um Administrador.',
	...
	'AVATAR_PHP_SIZE_OVERRUN'				=> 'O Ficheiro do Avatar é demasiado grande, sendo o máximo permitido de envio %1$d %2$s.<br />Por favor, nota que isto é definido no php.ini e não pode ser alterado.',
	...
	'BOARD_BAN_PERM'						=> 'Foi expulso permanentemente deste Fórum.<br /><br />Por favor, contacta o %2$sAdministrador%3$s para mais informações.',
	'BOARD_BAN_REASON'					=> 'Razão da expulsão: %s',
	'BOARD_BAN_TIME'						=> 'Foi expulso deste Fórum até %1$s.<br /><br />Por favor, contacta o %2$sAdministrador%3$s para mais informações.',
	...
	'LOGIN_ERROR_PASSWORD'				=> 'A Senha introduzida não está correcta, tenta novamente. Se continuar com problemas, contacta um %sAdministrador do Fórum%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'	=> 'Não foi possível converter a tua Senha ao actualizar este Fórum. Por favor peça uma %snova senha%s. Se continuar com problemas, contacta um %sAdministrador do Fórum%s.',
	'LOGIN_ERROR_USERNAME'				=> 'Especificou um nome de Utilizador incorrecto. Confirma o teu nome de Utilizador e tenta novamente. Se continuar com problemas, por favor, contacta um %sAdministrador do Fórum%s.',
	'LOGIN_FORUM'							=> 'Para ver ou enviar mensagens neste Fórum deves inserir a Senha.',
	'LOGIN_INFO'							=> 'O acesso completo ao Fórum necessita dum Registo que demora apenas alguns segundos. Antes de se Registar lê: FAQ - Condições de Utilização - Política de Privacidade Respeite as regras do Fórum.',
	...
	'NOT_AUTHORISED'					=> 'Não estás autorizado a aceder esta área.',
	...
	'NO_ACCESS_ATTACHMENT'				=> 'Não estás autorizado a aceder este Ficheiro.',
	...
	'UNABLE_GET_IMAGE_SIZE'				=> 'É impossível aceder ao Ficheiro de imagem, porque não é uma imagem válida. Por favor, verifica se o URL que inseriu está correcto.',
