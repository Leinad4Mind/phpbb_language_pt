...
$lang = array_merge($lang, [
	'TERMS_OF_USE_CONTENT'	=> 'Ao aceder a “%1$s” (doravante “nós”, “nos”, “nosso”, “%1$s”, “%2$s”), concorda em ficar legalmente vinculado aos termos seguintes. Se não concordar em ficar legalmente vinculado a todos os termos seguintes, por favor, não aceda nem utilize “%1$s”. Podemos alterar estes termos a qualquer momento e faremos todos os esforços para o informar dessas alterações. No entanto, é da sua responsabilidade rever este documento regularmente, uma vez que a utilização continuada de “%1$s” após a realização de alterações constitui a sua concordância em ficar legalmente vinculado aos termos atualizados e/ou alterados.
	<br><br>
	...
	<br><br>
	Compromete-se a não publicar material abusivo, obsceno, vulgar, difamatório, odioso, ameaçador, de cariz sexual ou de qualquer outra forma ilegal, seja ao abrigo das leis do seu país, do país onde “%1$s” está alojado ou do direito internacional. Essa conduta pode resultar na sua expulsão imediata e permanente e, se o considerarmos necessário, na notificação do seu fornecedor de serviços de Internet. O endereço IP de todas as mensagens é registado para ajudar a aplicar estas condições.
	<br><br>
	Concorda que “%1$s” se reserva o direito de remover, editar, mover ou encerrar qualquer tópico, a qualquer momento e ao nosso exclusivo critério. Como utilizador, concorda que todas as informações que introduzir podem ser guardadas numa base de dados. Embora estas informações não sejam divulgadas a terceiros sem o seu consentimento, nem “%1$s” nem o phpBB podem ser responsabilizados por qualquer tentativa de intrusão informática que possa comprometer os dados.
	',

	'PRIVACY_POLICY'		=> 'Esta política explica em detalhe como “%1$s” e as respetivas empresas afiliadas (doravante “nós”, “nos”, “nosso”, “%1$s”, “%2$s”) e o phpBB (doravante “eles”, “os”, “deles”, “software phpBB”, “www.phpbb.com”, “phpBB Limited”, “Equipas phpBB”) utilizam as informações recolhidas durante a sua utilização deste site (doravante “as suas informações”).
	<br><br>
	As suas informações são recolhidas de duas formas. Ao navegar em “%1$s”, o software phpBB cria vários cookies. Os cookies são pequenos ficheiros de texto guardados nos ficheiros temporários do seu navegador. Os dois primeiros cookies contêm um identificador de utilizador (doravante “user-id”) e um identificador de sessão anónima (doravante “session-id”), ambos atribuídos automaticamente pelo software phpBB. É criado um terceiro cookie depois de consultar tópicos em “%1$s”. Este guarda informações sobre os tópicos que leu, melhorando assim a sua experiência de utilização.
	<br><br>
	Também podemos criar cookies externos ao software phpBB enquanto navega em “%1$s”. Estes ficam fora do âmbito deste documento, que abrange apenas os cookies criados pelo software phpBB.
	<br><br>
	A segunda forma de recolhermos informações é através do que nos envia. Isto inclui, entre outros: publicar mensagens como utilizador anónimo (doravante “mensagens anónimas”), registar-se em “%1$s” (doravante “a sua conta”) e as mensagens que publica depois de se registar e enquanto está ligado (doravante “as suas mensagens”).
	<br><br>
	A sua conta contém, no mínimo: um nome de utilizador único (doravante “o seu nome de utilizador”), uma senha pessoal utilizada para entrar (doravante “a sua senha”) e um endereço de email válido (doravante “o seu email”). As informações da sua conta em “%1$s” são protegidas pelas leis de proteção de dados aplicáveis no país que nos aloja. Quaisquer informações para além do seu nome de utilizador, senha e endereço de email que sejam solicitadas durante o registo podem ser obrigatórias ou opcionais, segundo o critério de “%1$s”. Em todos os casos, pode escolher as informações da sua conta que serão apresentadas publicamente. Também pode optar por receber ou não os emails gerados automaticamente pelo software phpBB.
	<br><br>
	A sua senha é guardada como um hash unidirecional para garantir a segurança. No entanto, recomendamos que não reutilize a mesma senha em vários sites. A sua senha é a chave de acesso à sua conta em “%1$s”, por isso, guarde-a em segurança. Em circunstância alguma alguém associado a “%1$s”, ao phpBB ou qualquer terceiro lhe pedirá legitimamente a sua senha. Se se esquecer da senha, pode usar a opção “Esqueci-me da senha” disponibilizada pelo software phpBB. Este processo exige que indique o seu nome de utilizador e endereço de email, após o que o software phpBB irá gerar uma nova senha para recuperar o acesso à sua conta.
	',
]);
...
$lang = array_merge($lang, [
	...
	'ATTACHMENT_LOCKED'					=> 'Este tópico está bloqueado. Não pode remover o anexo.',
	...
	'CONFIRM_PASSWORD'					=> 'Confirme a sua Nova Senha',
	'CONFIRM_PASSWORD_EXPLAIN'			=> 'Preencher apenas se pretender alterar a Senha Atual.',
	...
	'FORCE_PASSWORD_EXPLAIN'		=> 'Por motivos de Segurança, é obrigatório que altere a sua senha.',
	...
	'NOTIFICATION_TYPE_FORUM'					=> 'Alguém respondeu a um tópico num fórum que está a observar',
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'	=> 'Uma mensagem ou tópico precisa de aprovação',
	'NOTIFICATION_TYPE_MODERATION_QUEUE'		=> 'Os seus tópicos/mensagens foram aprovados ou desaprovados por um moderador',
	'NOTIFICATION_TYPE_PM'							=> 'Alguém lhe enviou uma mensagem privada',
	'NOTIFICATION_TYPE_POST'						=> 'Alguém respondeu a um tópico que está a observar',
	'NOTIFICATION_TYPE_QUOTE'						=> 'Alguém citou uma mensagem sua',
	...
	'NOTIFICATION_TYPE_TOPIC'						=> 'Alguém criou um tópico num fórum que está a observar',
