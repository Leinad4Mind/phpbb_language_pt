...
$lang = array_merge($lang, [
	...
	'DOWNLOAD_REMOVE_IPS_EXPLAIN'		=> 'Pode remover (ou não-excluir) múltiplos endereços de IPs de uma única vez ao usar a combinação apropriada de rato e teclado para seu computador e navegador. IPs apagados têm um fundo em azul.',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'			=> 'Dimensões máximas das imagens anexadas. O phpBB pode tentar redimensionar automaticamente as imagens antes do envio para que respeitem estas dimensões. Defina ambos os valores como 0px por 0px para desativar a verificação de dimensões e o redimensionamento automático.',
