 ...
 * @Traduzido por: http://www.phpbb-pt.com & https://leinad4mind.top/forum - segundo as normas do Acordo Ortográfico (Versão Formal)
 */
...
$lang = array_merge($lang, [
	...
	'tokens'			=> [
		...
		'HASHMAP'			=> 'Associa sequências às respetivas substituições no formato <samp>{HASHMAP=sequência1:substituição1,sequência2:substituição2}</samp>. Distingue maiúsculas de minúsculas e, por predefinição, preserva valores desconhecidos.',
		...
		'MAP'				=> 'Associa sequências às respetivas substituições no formato <samp>{MAP=sequência1:substituição1,sequência2:substituição2}</samp>. Não distingue maiúsculas de minúsculas e, por predefinição, preserva valores desconhecidos.',
