...
$lang = array_merge($lang, [
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>O pacote de atualização Avançada é recomendado para utilizadores experientes apenas se os ficheiros originais do phpBB tenham sido modificados na sua instalação. Também pode atualizar a sua instalação usando os métodos listados no documento INSTALL.html. As etapas para atualizar o phpBB3 via pacote de atualização avançada são as seguintes:</p>
