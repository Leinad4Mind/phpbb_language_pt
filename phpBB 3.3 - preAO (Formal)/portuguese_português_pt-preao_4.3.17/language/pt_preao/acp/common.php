...
$lang = array_merge($lang, [
	...
	'ACP_PERMISSION_MASKS'			=> 'Máscaras das Permissões',
...
$lang = array_merge($lang, [
	...
	'VERSION_NOT_UP_TO_DATE_ACP'		=> 'A sua instalação do phpBB não está actualizada.<br />Abaixo está um link para o anúncio de lançamento, que contém mais informações, bem como as instruções sobre como actualizar.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'A sua instalação do phpBB não está actualizada.',
	'VERSION_UP_TO_DATE_ACP'		=> 'A sua instalação do phpBB está actualizada. Não há actualizações disponíveis de momento.',
...
$lang = array_merge($lang, [
	...
	'LOG_WARNING_DELETED'					=> '<strong>Eliminados avisos de utilizadores</strong><br />» %s',
	'LOG_WARNINGS_DELETED'		=> [
		1 => '<strong>Apagado aviso do utilizador</strong><br />» %1$s',
		2 => '<strong>Apagados %2$d avisos do utilizador</strong><br />» %1$s', // Exemplo: '<strong>Apagados 2 avisos do utilizador</strong><br />» xpto'
	],
	'LOG_WARNINGS_DELETED_ALL'				=> '<strong>Eliminados todos os avisos do utilizador</strong><br />» %s',
	...
	'LOG_EXT_PURGE'							=> '<strong>Dados da extensão removidos</strong><br />» %s',
