...
$lang = array_merge($lang, [
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>O método recomendado de actualizar a sua instalação é via pacote completo. Caso os ficheiros originais do phpBB tenham sido modificados na sua instalação, poderá desejar usar o pacote de actualização avançada para evitar perder essas alterações. Também pode actualizar a sua instalação por outros métodos listados no INSTALL.html. As etapas para actualizar o phpBB3 via pacote completo são as seguintes:</p>
		...
		<h1>Como actualizar a sua instalação com o Pacote de Actualização Avançada</h1>

		<p>O pacote de actualização Avançada é recomendado para utilizadores experientes apenas se os ficheiros originais do phpBB tenham sido modificados na sua instalação. Também pode actualizar a sua instalação usando os métodos listados no documento INSTALL.html. As etapas para actualizar o phpBB3 via pacote de actualização avançada são as seguintes:</p>
		...
		<p>Depois de enviado, o seu fórum ficará inacessível aos utilizadores normais, caso a pasta de instalação que supostamente acaba de enviar esteja realmente presente.<br /><br />
